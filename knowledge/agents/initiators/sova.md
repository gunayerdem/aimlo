...
## 1. Rol Kimliği
Sova'nın silahı bilgi. Recon, dart ve drone — üçü de her tur tekrar tekrar elinde. Takım kör girdiği yere sen kör girme. Ne kadar çok nokta ezberlersen o kadar tehlikelisin. Nokta bilmeden sahaya çıkma.
...
- İki dart'ı da spike kurulana kadar elinde tut
...
- İki dart'ı da spike kurulmadan harcamak — defuse'u engelleme şansını kendin kapatıyorsun
...
**COUNTER** Kapağın arkasına çekil, drone'u kısa sür, bir arkadaşın seni kollasın. Ölürsen aldığın bilgi çöpe gider.
...
**MEANING** Nokta dağarcığın zayıf — rakip seni okur, dart'ın değersizleşir
...
**Oyuncu Eylemi:** Recon'ları savunmacının, giriş yolundan bakışını çevirmeden vuramayacağı tavan ve duvar noktalarına indiriyorsun. İki dart'ı da spike kurulana kadar elinde tutuyorsun.
...
**Düşman Tepkisi:** Ya dönüp dart'ı vuruyor ve giriş açısından kısa süreliğine kopuyor, ya da görmezden gelip pozisyonunu tüm takımına açık ediyor. İki seçenek de onun için kötü.
...
**Düşman Adaptasyonu:** Dört beş tur sonra savunmacılar dart'ın indiği noktayı önceden nişanlar, taramanın dışında durur ya da dart inmeden push atar.
**Karşı-Adaptasyon:** Önceden nişanlıyorlarsa — farklı noktaya inen alternatif dart kullan. Taramanın dışında duruyorlarsa — tahmin edilebilir bir yere itiyorsun, bunu takıma söyle. Erken push atıyorlarsa — noktayı atla, drone'u reaktif sür ve pozisyonu takıma bildir.
...
- **Orta (Gold-Platinum)**: Site başına üç noktaya çık. Spike sonrası dart iniş noktalarını kasıtlı çalış. Önce drone, sonra recon — bu sırayı alışkanlık yap.
- **Yüksek (Diamond-Ascendant)**: Savunma ve retake recon noktaları dahil tam dağarcığı kur. Ult'i recon bilgisiyle kombinle. Tuhaf açıdan inen dart noktaları ekle.
- **Elit (Immortal-Radiant)**: Rakibin ilk üç turda hangi noktaları tuttuğunu izle, dart seçimini buna göre değiştir. Drone rotalarını önceden nişanlanan açılardan kaçacak şekilde planla. Dart zamanlamasını çeşitlendir — spike sonrası her tur aynı anda atma, yoksa rakip ritmini öğrenir.

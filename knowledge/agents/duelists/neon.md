...
MEANING: Duvar koruması olmadan açık açılardan koşuyorsun ya da takım arkadaşının flash/smoke'u olmadan giriyorsun
...
COUNTER: Takım util'i bir açıyı temizlesin, o açı kapanınca sprint at. Temizlenmemiş açıya girme.
WHY: Düşmanın yerini bilmeden sprint atmak kör giriştir. Hız avantajın bir anda dezavantaja döner.

IF: Duvarını açmadan sık ölüyorsun
MEANING: Kit'inin yarısını görmezden gelip sadece ayağına güveniyorsun
...
- **Zayıf haritalar:** Ascent (mid çok açık, site'lar dikey oyun ister). Breeze rework'le koridor kazandı — aşağıdaki Breeze notuna bak.
...
- **Summit — zayıf, hat seç (yeni harita):** Uzun A Main, Mid Fountain ve B Main hatlarında sen varamadan uzaktan düşersin — hız tek başına burada giriş açmaz; initiator util'i bir açıyı kapatmadan sprint atma. Duvarını geniş B Main girişinde crossfire'ı bölmek için aç, B Tower açısını duvarın kessin, sonra koş.

...
## Savunmada Görevin
- 1v1'e dönecek açıları tut. Düşman toplu geliyorsa duvarla araya gir, teker teker dövüş.
- Kalkan ilk atışı yer, sana trade penceresi açar — ileri pozisyon tut, geri çekilme.

## 3. Sık Yapılan Hatalar
1. **Kalkanı açmadan dövüşe girmek** — Peek atmadan önce kalkan açık olacak. Açık değilse kalkan yok, Iso avantajı yok.
2. **Duvarı izolasyon yerine görüş kesmek için kullanmak** — Bu Viper duvarı değil. Amacın düşman grubunu bölmek, birini ayırıp dövüşmek. Sırf görüşü kapatmak için kurarsan izolasyonu kaybedersin.
3. **Kalkanla birden fazla açıya swing atmak** — Kalkan tek bir hasarı emer. İki düşmana geniş açıyla yüklenirsen kalkan ilk mermide biter, ikincisine çıplak girersin. Kalkan 1v1 içindir.
4. **Ult'u zayıf hedefe atmak** — Hasarlı ya da zaten kaçan birine ult atma. Site'ı tutan sentinel'e at, anchor'a at — düşürünce round'u açacak hedefe at.
5. **Öldürme sonrası küreyi kaçırmak** — Küre kısa süre durur. Vurmayı kaçırırsan kalkan gelmez, Iso'nun tüm döngüsü kırılır.
...
COUNTER: Önce duvarı kur, sonra dövüş. Birden fazla düşman varsa duvar araya girsin — sadece biriyle karşılaş.
WHY: Kalkan 1v1'de avantaj verir. İki açıdan ateş gelirse kalkan ilk mermide biter.

IF: Ult attın ama arena dövüşünü kaybettin
MEANING: Zor hedefe ult attın ya da arena'da kötü konumlandın
COUNTER: Hedef seçimi her şeydir. Yerinde duran, kaçamayan birine at — sentinel, anchor. Arena'da giriş kapısının karşısındaki kutunun arkasına geç, düşmanın çıkış noktasını kapı çerçevesinden bekle.
WHY: Ult en çok yerinden kıpırdayamayanlara karşı çalışır. Hızlı bir duelist'e atarsan arena'da dezavantajlı kalırsın.

IF: İlk öldürme oranın yüksek ama hemen arkasından ölüyorsun
MEANING: Öldürdün ama küreyi toplamadın, sonraki dövüşe kalkansız girdin
COUNTER: Ritim şu: öldür → küreyi vur → yeniden konumlan → sıradaki dövüşe gir. Küre toplamak gecikme değil, yatırım.
WHY: Kalkan yenilenmezse sıralı düello avantajın kırılır. Her yeni dövüşe dezavantajlı başlarsın.

IF: Duvarı kullandın ama izole öldürme çıkmadı
MEANING: Duvarı yanlış açıda ya da çok erken kurdun — düşmana kaçacak süre verdin
...
WHY: Iso bir entry duelist'i — duvar ve kalkan takımı içeri sokmak için. Tek başına sayı biriktirip site'ı geç alırsan yetenek setin takıma değer üretmez.

## 5. Harita Etkileşimleri
- **Güçlü haritalar:** Ascent (mid 1v1'e açık, duvarla Market'i B site'tan kes), Haven (bol choke var — duvarla savunucuyu ayır, biriyle dövüş), Pearl (uzun koridorlar duvara ve sıralı temizliğe çok uygun), Split (dar site'lar kalkan biriktirmek için ideal).
- **Zayıf haritalar:** Icebox (dikey oyun duvarın verimini düşürür, B site Iso'nun yer seviyesi izolasyonu için fazla açık). Breeze rework'le izolasyon lehine daraldı — aşağıdaki Breeze notuna bak.
- **Somut açılar:** Ascent A site'ta duvarı Heaven ile generator arasına kur — bir 1v2'yi, kazanabileceğin iki ayrı 1v1'e böl. Haven C site'ta duvarı Garage'dan oynayan savunucuyu arka site oyuncusundan kesecek şekilde kur — Iso'nun en güçlü execute açılarından biri budur.
...
- **Baskıladığın ajanlar:** Yerinde açı tutan savunucular — kaçamayacakları 1v1'e zorla. Killjoy (ult'la onu bot kurulumundan koparıp tek başına çekersin), Cypher (duvar tellerin üstünden atlar), Chamber (tuzağı olmadan onu doğrudan nişan düellosuna zorla).
- **Adaptasyon:** Raze'e karşı orta mesafede dur, patlamanın tam menzilinden çık. KAY/O bastırması bitince gir. Breach'e karşı sıkışık koridorlardan uzak dur — kitin orada çalışmaz.
...
## 8. Bu Ajana Karşı
- Iso'nun kozu kalkan: ilk isabeti emer. Düelloyu iki mermiye göre planla, kafa hizasında kal — ilk atış kalkanı kırar, ikincisi bitirir. Vücuda seri sıkarak kalkanı kırdıysan crosshair'i hemen kafaya geri çek.
- Duvardan geçen okunu yediysen işaret üstündeyken peek etme — o pencerede aldığın her hasar ikiye katlanır ve yeteneklerin kapalı. Pencere geçtiği an açıyı sen bas: kombosunu harcadı, kalkanı da tek atımlık.
- Duvarıyla seni 1v1'e zorlar ve takım arkadaşının trade'ini keser. Düelloyu onun seçtiği anda kabul etme — duvar hattından geri çekil, takım arkadaşının açısına yerleş; izolasyonu bozulan Iso sıradan bir duelist.
- Kalkan tek seferlik hasar emer — kaynağı fark etmez: ilk mermi de ilk molly tiki de kalkana gider. Molly yine de verimli: ilk tik kalkanı kırar, kalan tikler çıplak vurur ve onu pozisyonundan söker. Stun ve flash gibi hasarsız util'i kalkan hiç engellemez — düelloyu onlarla kur.
- Kalkanı kısa ömürlü ve yenilenmesi öldürme ister: ilk düelloyu geciktir ya da iki açıdan aynı anda bas — tek kalkan iki açıya yetmez, sönmüş kalkanla dövüşen Iso kit avantajsız kalır.

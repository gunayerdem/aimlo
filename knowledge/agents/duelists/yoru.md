...
- **Zayıf haritalar:** Lotus (döner kapılar flank beklentisini artırır, TP değeri düşer). Breeze rework'le aldatma alanı kazandı — aşağıdaki Breeze notuna bak.
...
- **Açık haritada sınır:** Icebox gibi uzun-açık hatlarda (ve Breeze'in A Main gibi kalan uzun hatlarında) flash sektirecek duvar az, klon uzaktan vurulup yok edilir. Buralarda Yoru'yu yakın-orta menzilde tut; TP'yi uzun hatta değil, dövüşün gerçekten yaşandığı sıkışık geçişin arkasına göm.
...
- **Breeze (rework sonrası) — aldatma alanı açıldı:** "Kapak yok, TP saklanmaz" dönemi bitti — A'nın arka-duvar kutuları ve B'de büyüyen Cubby TP'ne gömme noktası verir. Otomatik kapılar senin oyunun: kapı sesi bedava yem — yaklaş, sesi ver, geçme; savunucu Mid'e dönerken sen A Main'den gir, klonla kapı hattını gerçek göster. A Main gibi kalan uzun hatlarda klon uzaktan patlatılır — klon-flash kombonu dar Mid koridorlarında kur.
- **Corrode:** Mid Window rotasyonun kilit kapısı — TP sesiyle savunucuyu yanlış tarafa çek: küreyi bir site tarafına göm, sesle rotasyonu tetikle, gerçek girişini öbür koldan yap. Klonu Stairs–Top Mid uzun hattına sürme — uzaktan vurulur; klon-flash'ı A Main ve B Main dar girişlerinde çalıştır, Elbow ve Pocket köşelerini flash'la aç. B'de Tower yukarıdan bakar: TP ile hattın arkasına geçtiysen bile dikeyi hesaba kat.
- **Ascent — mid'den aldat:** Mid merkezli harita sahte-gerçek oyununa alan verir: Catwalk'ta ses ver, TP'yi Market tarafına göm — savunucu A split beklerken sen B'ye inersin (ya da tersi). Market/B Link rotasyonun kalbi: küreni oraya gömüp sesiyle rotasyonu tetikle, gerçek girişi öbür koldan yap. Mekanik kapılar ekstra ses katmanı — kırma sesi "geliyorum" der, o sesi yem yap, geçme; kapalı kapının arkasına TP gömme, döndüğünde tıkalı yola saplanırsın. A Main uzun hattında klon uzaktan patlatılır — klon-flash'ı B Main dar girişinde çalıştır.
- **Sunset — kapı ve kısa koridorlar:** Kısa görüş hatları klonu uzaktan patlattırmaz — klon-flash kombon burada tam değerinde. B Market Kapısı senin oyunun: kapı sesi + TP sesiyle savunucuyu Market'e çek, gerçek girişi B Main'den yap — iki ses kaynağı savunmayı ikiye böler. TP'yi Market köşesine ya da duman içine göm; Mid Courtyard'ı tutan split'i yapar — klonu Courtyard hattına sür, gerçek geçişini A Link'ten kur.
...
### İyi oynarken
**Oyuncu Aksiyonu:** Bir siteye klon gönderirken TP öbür siteye gömülü, lurk zamanlaması roundlar arasında erken-geç-yok diye değişiyor.
**Düşman Algısı:** Savunucular klon ayak sesini duyar, push geliyor sanır. 1-2 kişi sese döner. Tam o anda nerede olduğunu kaybederler — ses iki noktaya bölünmüştür.
**Düşman Tepkisi:** Ya klona döner, gerçek siteyi eksik bırakır. Ya görmezden gelir, ama bu sefer gerçek olma riskini alır. İkisi de kaybettiren seçim.
**Fırsat Penceresi:** 1-2 savunucu klonun olduğu siteye döndüğünde gerçek site eksik oyuncuyla tutuluyor. TP'yi bu boşlukta aç, varışta flash'ı kalan savunucuya at.
...
## 8. Bu Ajana Karşı
- Yoru'nun kozu aldatma: önde gördüğün klon çıkabilir. Klonu yakın mesafede patlatma — patlama körlük basar ve gerçek Yoru tam o pencerede girer. Uzaktan tek mermiyle patlat ya da hiç vurma; gerçek geliş açısını tut.
- TP küresinin sesi ve görünümü bellidir: gördüğün küreyi hemen yok et. Işınlanma sesini duyduğun an çıkış noktasına dön — varışta silahını yeni çıkarır, ilk atış sende.
- Sektirilmiş flash gördüğün an arkanı dön ve bir adım geri çekil — patlamayla aynı anda girer. Körlenmediysen dönüşünde açıyı sen bas: girişini senin körlüğüne kurdu, kör değilsen plan çöktü.
- TP'si tek hak: girişte harcadıysa kaçışı yok. Işınlanma sesinden sonra baskıyı kur — trade mesafesinde takımı yoksa saplandığı açıda karşılıksız yakalarsın.
- Bütün oyunu sesi ikiye bölmek: klon ayak sesi de TP sesi de rotasyon çektirmek için. Tek ses kaynağıyla pozisyon bozma — görsel doğrulama gelmeden yerinden oynama; sese dönmeyen savunucu Yoru'nun kitinin yarısını kapatır.

...
## 1. Rol Kimliği
Clove, klasik pasif smoke atan controller değil. Öldükten sonra bile smoke atabiliyorsun — başka hiçbir controller bunu yapamaz. Kill aldığında fazla can kazanırsın, Meddle ile düşmanı zayıflatırsın, ölsen bile kendini diriltebilirsin. Clove ile hem dövüşürsün hem de takımın smoke'larını çıkarırsın. İkisini birden yapamıyorsan Clove'u doğru oynamıyorsun.
...
- Ölüm noktasında kendini diriltip anında tekrar ölmek
- Smoke atmadan dövüşe dalmak — frag smoke'tan önce gelmiyor
- Meddle'ı takımın aktif dövüşmediği düşmanlara atmak — decay boşa gidiyor
- Fazla canı bahane edip daha tehlikeli açılara girmek — fazla can bonus, gerekçe değil
- Her ölümde direkt Not Dead Yet kullanmak — çıkış güvenli mi önce kontrol et
...
**MEANING** Geçici HP seni yanlış cesur yapıyor
**COUNTER** Fazla can azalır. O HP'yi daha ileri gitmek için değil, şu anki pozisyonu daha sağlam tutmak için kullan.
**WHY** Fazla can biterken dezavantajlı bir dövüşte sıkışırsın.

**IF** Sürekli entry frag atıyorsun ama takımın smoke'u yok
**MEANING** Clove'u duelist gibi oynuyorsun, controller görevini bırakmışsın
**COUNTER** Önce smoke'ları at, sonra dövüş. Ölsen bile smoke'ların çıkmış olması gerekiyor.
**WHY** Smoke'suz entry takımı açık bırakır — controller rolü her zaman kendi fragından önce gelir.
...
## 6. Eşleşme Notları
- **Sage'e karşı**: Sage duvarı Meddle'ı engellemez. Duvarın arkasındaki oyunculara da decay geçer.
- **Chamber'a karşı**: Chamber teleportunu zaten kullandıktan sonra Meddle at — kaçış yolu yokken yakala.
- **Duelist ile**: İkili entry yapabilirsiniz. Sen ölürsen smoke'lar yine çıkar. Hayatta kalırsan Pick-Me-Up ile devam edersin.
- **Fade'e karşı**: Fade'in Haunt'u ölüm noktanı gösterir, diriliş zamanını ele verir. Dirilişini geciktir ya da farklı açıdan çık.
...
"Rakipler diriliş noktanı kamp ediyor. Ya diriliş'i atla ve takımın trade'inden oynasın, ya da onlar çekilene kadar bekle."

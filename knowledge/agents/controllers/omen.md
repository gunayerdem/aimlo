...
## 1. Rol Kimliği
Sen tek başına iş çeviren bir smoke ajanısın. Görevin sadece duman atmak değil — dumanı at, sonra yer değiştir ki düşman aynı anda iki yere bakmak zorunda kalsın. Öbür smoke ajanları takıma yapışık oynar; sen oynamazsın. Teleport, flash ve smoke aynı anda çalıştığında düşman önce neye tepki vereceğini şaşırır. Yeteneklerin yaratıcı oyunu ödüllendiriyor — ama kafana şunu kaz: önce smoke, sonra her şey.
...
**COUNTER** Her yarı için 3 ayrı teleport noktası belirle, her round birini değiştir. Bir round hiç teleport kullanma — düşman seni ararken takımın girişi karşısız kalır.
...
**COUNTER** Spike kurulduktan sonra karşı bölgeye geç ve orada varlık yarat. Savunmada bir bölgeden ötekine hızlıca dön. Karşı bölgede sahte ses bırak.
**WHY** Ult seni haritanın istediğin yerine atar. Bunu sırf sürpriz baskıya harcamak en büyük kozunu çöpe atmaktır.

**IF** kısa teleport sırasında ya da hemen sonrasında sık sık ölüyorsun
**MEANING** Reaktif teleport atıyorsun — çatışma başladıktan sonra kaçmaya ya da yer değiştirmeye çalışıyorsun.
...
- **Icebox**: Tube, nest ve rafters'a teleport beklenmedik açılar verir. A site'ta pipe'lardaki smoke tek yönlü açı açar.
...
- **Breeze**: Rework sonrası gerçek seçeneksin — Nest ve Mid koridor ağızları standart smoke'la tam kapanır, "Viper yoksa oynanmaz" dönemi bitti. Smoke önceliğin A Main'in uzun hattı ile Nest; B'de Window hattını dumanla kes — B Main site içinden ve Window'dan çapraz tutulur. Kısa teleport Nest'e çıkan az yoldan biri: çık, ilk teması gör, haber ver, in — smoke gelince orada oturma. Çift kapının (Chute) sesini akıl oyununa çevir: kapıya yaklaşıp sesi ver, savunucu Mid'e dönerken sen teleportla başka açıdan çık. Rotasyonlar kısaldı — retake ve yeniden kapama için en az bir smoke sakla.
...
### İyi oynadığında
**Oyuncu Eylemi:** Takım giriş yapmadan hemen önce flash atıyorsun ve her round farklı bir teleport noktası kullanıyorsun.
...
- Omen kendi smoke'unun kenarında oynamayı sever — dumandan çıkan ilk silüeti bekleyen açı tut, o düelloyu hazır olan kazanır.
- Ult sesi tek başına kanıt değil — Omen ışını iptal edip yerinde kalabilir; gölge şeklini görürsen vur (vurulan Omen eski yerine döner), görmüyorsan pozisyonunu sese göre bozma.
- Flash'ı duvardan geçer ve gelirken ses verir — sesi duyduğun an görüş hattından çık; kör yakalanan köşe tutuşu bedava ölümdür.

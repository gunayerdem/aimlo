...
- **Örnek**: Ascent'te A Main'den içeri girerken crosshair'in yerde, düşman A Site'tan kafadan vurup öldürdü — köşeye girmeden crosshair'i, o köşeden bir düşman kafasının çıkacağı yüksekliğe oturt, sonra gir.

### Crosshair'i baş hizasında tut

- **IF** crosshair'in vücut hizasında ya da daha aşağıda dururken ölüyorsan
- **MEANING** her düelloya bir adım geride başlıyorsun; kafayı vurmak için mouse'u ekstra yukarı çekmen gerekiyor, o yarım saniyeyi kaybediyorsun
- **COUNTER** köşeye girmeden ÖNCE crosshair'i, o köşeden bir düşman kafasının çıkacağı yüksekliğe oturt; sonra duvar boyunca yürürken bu hizayı bozma; düşman göründüğü an mouse'u yukarı çekmeden tetiği çek
...
- **COUNTER** düşmanı gördüğün an koşmayı kes ve tamamen dur; tam durduktan sonra atışını yap; atış bitince tekrar hareket et — dur, ateş et, çekil; durmadan asla tetik çekme
...
- **Örnek**: Bind'de B Site ortasında açıkta dururken Hookah'tan ve B Long'dan iki yönden görünüp öldün — kutunun kenarına otur, tek açı tut, vurulunca tek adımda kapanabileceğin yerde dur.
...
- **COUNTER** peek'ten önce yanındakiyle anlaş; "üç deyince" deyip aynı anda hareket edin; sen geniş açıyla peek at, o yan açıda hazır beklesin; sen vurulursan o seni vuran düşman daha senin bedenine bakarken hemen geri alsın
...
- **COUNTER** ilk ayak sesini duyunca kaçma; girişe bir util at ve girişi yavaşlat, sonra çapraz bir pozisyona kay ve bekle; ölmeye çalışma, sadece zamanı al — bir util atıp çekil, başka bir şey yapma
- **WHY** giriş yavaşlayınca takımın yer değiştirmeye yetişir, düşman util harcamak zorunda kalır, geri-alım mümkün hale gelir
...
- **COUNTER** smoke'u erken atma; ayak sesini duyduğunda ya da takımdan "hazır" sinyali geldiğinde at; atışı sezgine değil, bu somut tetikleyiciye bağla ki smoke takım girerken hâlâ ayakta olsun
...
- **COUNTER** daha hızlı nişan almaya çalışma; dövüş başlamadan önce bilgini al ve açıyı kendi lehine kapatacak pozisyona erken gir; düşman gelmeden açın hazır olsun ki o görününce sen zaten bakıyor ol
- **WHY** doğru pozisyona zamanında girmek, dövüşü sen daha ateş açmadan kazandırır

## Okunabilirlik ve Bilgi Sızıntısı Ölümleri

Aynı şeyi tekrarladığın için düşman seni okudu. Sorun pozisyonun ya da nişanın değil — tahmin edilebilir oldun. İyi rakip round kaydını izler; tekrar ettiğin her hareketi bir sonraki maça ezberleyerek gelir.

- **Örnek**: Ascent'te dört round üst üste A Long'u aynı recon-sonra-flash sırasıyla zorladın, beşinci round düşman flash'ı önceden duyup beklediği için öldün — bir round o açıyı boş bırak ya da sırayı boz, düşman okumasını kullanamadan yeniden tahmin etmek zorunda kalsın.
...
- **COUNTER** bir sonraki round'da bilinen sıranı değiştir; rakip senin önce recon atmanı bekliyorsa, bu kez önce smoke at ya da flash'ı sona bırak; rakip alıştığı sırayı görmeyince hazırlığını boşa harcar, sen onları boş bulursun
...
- **COUNTER** iki round aynı üst pozisyondan baktıysan üçüncü round oraya hiç gitme; rakip o açıyı kesmek için nişanını oraya almış gelecek diye varsay ve farklı bir noktaya geç; oynamasalar bile oynayacaklarmış gibi davran
...
- **COUNTER** bir round o pozisyonu tamamen boş bırak ve farklı bir noktada tut; düşman oraya hazırlığını boşa harcayınca ve orayı kontrol etmeyi bırakınca geri dön — örneğin dört round A short tuttuysan ve karşı Raze artık oraya körlemesine molly atıyorsa, bir round başka noktada bekle, molly'sini boşa attırt, sonra dön
...
- **MEANING** rakip seni bir şeyden okuyor; sorun pozisyon değil — ayak sesin, util sıran ya da köşeye yaklaşma alışkanlığın bilgi sızdırıyor
- **COUNTER** pozisyonu değiştirme, sızdıran alışkanlığı değiştir; bu round o açıya sessiz yürü, util'i farklı sırayla at, köşeye her zamankinden farklı bir mesafede yaklaş; rakibe verdiğin her tekrar eden ipucunu tek tek kes
...
- **COUNTER** dövüşe girmeden önce dur ve sor: pozisyon, util ya da bilgi bana üstünlük veriyor mu? Hiçbiri yoksa o açıyı zorlama, geri çekil ve bir üstünlük kurulana kadar bekle; üstünlük gelince dövüşü aç
...
- **IF** 1v1 ve 1vX clutch durumlarında ölüyorsan
...
- **Örnek**: Icebox'ta 4v2 öndeyken bir kill daha almak için B Site'a fazladan peek atıp 3v2'ye düştün — sayı avantajında peek arama, köşeleri kur ve bekle, düşmanı sana gelmeye zorla.
...
- **COUNTER** sayı avantajını gördüğün an ikinci giriş aramayı bırak; köşeleri temizle, çapraz pozisyonları kur, sonra bekle; dövüşü sen açma, zamanı işlet ve düşmanı sana peek atmaya zorla
...
- **IF** 4v2'desin ve peek atıp 3v2'ye düşüyorsan
- **MEANING** o round zaten sendeydi, sıfır kazançlı bir risk ekledin
- **COUNTER** 4v2'ye düştüğün an peek dürtüsünü bırak; tuttuğun köşeyi koru, zamanı oyna, düşman zamandan dolayı sana gelmek zorunda kalana kadar bekle; sen ona değil o sana gelsin
- **WHY** avantajlıyken her gereksiz peek round'u eşitler, kazanmaz
...
- **Örnek**: Ascent'te bir düşman üç round üst üste B Main'den takımının sesini beklemeden tek başına peek attı — dördüncü round o peek'e başlamadan, ayak sesini duyar duymaz oraya flash at, kör peek'i karşıla.
...
- **MEANING** bu tekrarlanan bir alışkanlık, karşı hamle için kullanabilirsin
- **COUNTER** bir sonraki round o açıyı önceden hazırla; düşmanın o noktadan gelen ayak sesini duyar duymaz, daha o peek'e başlamadan oraya flash at; flash patlayınca açıyı tutan takım arkadaşın temizlesin
...
- **MEANING** tahmin edilebilir; karşı hamleyi önceden hazırlayabilirsin
...
- **MEANING** o ajanın round'da ne yaptığını okumuyorsun — hangi util'i nereye attığını, hangi açıyı tuttuğunu bilmiyorsun
- **COUNTER** önce o ajanın sana karşı ne yaptığını net belirle, sonra tek bir karşı hamle kur ve onu tetiğe bağla: o ajanın recon util'i havaya kalktığı AN açıyı boş bırak; smoke attığı geçişi o smoke inince başka yoldan al
...
Kayıpların büyük kısmı birlikte hareket edememekten gelir. Bilgi havadayken açılan boşluk küçük bir penceredir; o pencereyi zamanında kullanmak gerekir.

- **Örnek**: Sunset'te takım arkadaşının recon util'i Mid'de düşmanı gösterdi ama kimse basmadı, bir saniye sonra düşman yeniden açısına oturdu ve taze bilgi boşa gitti — recon biter bitmez, araya süre koymadan geniş açıyla peek at.
...
- **COUNTER** smoke'u düşman öldürmek için değil, bir geçişi kapatmak için at; round boyunca o geçişi kapalı tut; düşman o smoke'tan geçmeye kalkarsa sesini duyar, geçemezse başka yola yönelir — iki durumda da yerini öğrenirsin
...
- **Örnek**: Ascent pistol round'unda hiç util kullanmadan A Site'a koşup hazır bekleyen düşmana öldün — girişi en az bir util ile aç: girişe smoke at ya da içeri flash at, sonra gir.

- **IF** pistol ve ilk silah round'larında ölümlerin yoğunsa
- **MEANING** ya ekonomi kararı kötü ya da util kullanmadan site'a koşuyorsun; bu çoğunlukla karar hatasıdır, nişan hatası değil
- **COUNTER** site'a koşmadan önce en az bir util hazırla; girişe smoke atıp görüşü kes ya da içeri flash atıp düşmanı kör et, util etki ettiği AN gir; ekonomiyi de round başında takımla aynı karara bağla

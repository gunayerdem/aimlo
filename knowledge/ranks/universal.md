...
- **IF** crosshair'in vücut hizasında ya da daha aşağıda dururken ölüyorsan
- **MEANING** her düelloya bir adım geride başlıyorsun; kafa için mouse'u ekstra yukarı çekmen gerekiyor, ilk atışı o arada kaybediyorsun
- **COUNTER** köşeye girmeden ÖNCE crosshair'i o köşeden çıkacak kafanın yüksekliğine oturt; duvar boyunca yürürken hizayı bozma; düşman göründüğü an mouse'u yukarı çekmeden tetiği çek
- **WHY** crosshair zaten baş hizasındaysa düşman göründüğü an vurursun, ayar yapmadan ilk atışı sen yaparsın

### Dur, ateş et, sonra hareket et

- **IF** koşarken ya da yana kayarken tetik çekiyorsan
- **MEANING** saçılım o kadar açılır ki mermiler hedefin etrafına gider, kafadan vurmak şansa kalır
- **COUNTER** düşmanı gördüğün an tamamen dur; durduktan sonra atışını yap; atış bitince tekrar hareket et — dur, ateş et, çekil; durmadan asla tetik çekme
- **WHY** sadece durduğun an isabet edersin; hareket halinde eşit nişandaki düşman seni geçer

### Açık nişanla eşit düello

- **IF** crosshair hazır olduğu halde düelloları kıl payı kaybediyorsan
- **MEANING** sorun yükseklik değil, ilk atış disiplini; köşeyi dar açıyla kırıyor ya da iki düşmanı aynı anda göstermesine izin veriyorsun
- **COUNTER** köşeye yapışık çıkma; bir adım geri açıl ki düşmanlar teker teker görünsün; ilk düşman görünür görünmez tek atışta indir, indirdiğin AN bir sonrakine geç; yakın mesafe dışında spray'i zorlama
- **WHY** geniş açı düşmanı tek tek karşına getirir, ilk atış üstünlüğü sende kalır

## Pozisyon ve Açı Ölümleri

Yanlış yerde durduğun için vuruldun — açıkta kaldın, birden çok yerden görünüyordun ya da çekilecek yerin yoktu.

- **Örnek**: Bind'de B Site ortasında açıkta dururken Hookah'tan ve B Long'dan iki yönden görünüp öldün — kutunun kenarına otur, tek açı tut, vurulunca tek adımda kapan.

### Açıkta değil, siperin yanında dur
...
- **IF** duvar ya da smoke daha açılırken içeri giriyorsan
- **MEANING** düşman tam o anı bekliyor, sana hazır nişanla bakıyor; en kötü anda çıkıyorsun
- **COUNTER** smoke tam oturana kadar bekle, oturunca bir an daha bekle ki düşman beklemeyi bıraksın; o gevşeme anında geniş açıyla tek adım peek at, ilk atışı sen yap
...
- **IF** seni bir Operator (ya da uzun hattı tek atışla kapatan başka bir keskin nişancı silahı) uzun bir hattan, çoğu zaman aynı açıya aynı anda çıktığında vurduysa
- **MEANING** Operator tek bir açıya kilitlidir ve sabit timing'le çıkan oyuncuyu bedavaya alır — sen ona kendi ritminde, beklediği anda hediye oldun
- **COUNTER** o açıya util'siz ikinci kez aynı timing'le çıkma; üç seçenek: (1) takım smoke'uyla hattı kapat, (2) Operator ateş ettiği AN — sesini duyarsın — o daha silahını yeniden kurmadan tek adımda re-peek at, (3) farklı yükseklikten ya da daha geniş swing'le zorla ki tek-açı nişanı tutmasın
- **WHY** Operator tek hedefe kilitlidir ve her atıştan sonra silahını yeniden kurmak zorundadır; timing'ini değiştirirsen o silah pahalı bir dezavantaja döner
...
- **MEANING** düşman rotasını tamamlamış, açısına oturmuş; sen tam oturmasını bekledikten sonra çıkıyorsun
- **COUNTER** düşmanın ayak sesini dinle; ses sürerken çıkma; kesildiği AN, düşman henüz yeni açısına oturmadan tek adımda peek at
...
- **COUNTER** çıkmadan önce somut tetikleyici bekle: takım arkadaşın karşıyı ateşle bağlasın, düşman smoke'u yere insin ya da ayak sesi yaklaşsın; biri gelmeden geniş açıyla peek atma, geldiği an çık
- **WHY** tetikleyiciye bağlı agresyon çok daha yüksek oranda tutar; tetikleyicisiz peek 50/50'dir

### Util'i tetikleyiciye bağla

- **IF** takım daha hareket etmeden smoke atıyorsan
- **MEANING** smoke bittiğinde giriş açık kalır, düşman rahatça karşılık verir
...
### Dövüşü sen aç — yürürken yakalanma

- **IF** 1v1/1v2'de düşmanla karşılaştığın anda hâlâ yürüyorsan ya da açıyı daha yeni kırıyorsan
- **MEANING** dövüşü sen açmıyorsun, dövüş seni yakalıyor; hareket halinde yakalanan taraf ilk atışı veremez
- **COUNTER** hızlı nişan almaya çalışma; ayak sesi hangi yönden geliyorsa o yönü TEK BAŞINA gören bir noktaya önce yerleş, dur ve crosshair'i o hizada tut, düşman göründüğü an tetiği çek — sonra yer değiştir
- **WHY** dövüşün yerini ve anını sen seçersen ilk atış sende olur; koşarken açılan her düello 50/50'ye döner
...
- **IF** aynı açıyı/pozisyonu iki round üst üste tuttuysan ya da orada art arda öldüysen
- **MEANING** pozisyon yanlış değildi, tekrar yüzünden tahmin edilebilir oldu — rakip artık nişanını oraya almış girer, sen çıkmadan vurur
- **COUNTER** ikinci tekrardan sonra o noktaya hiç gitme: bir round tamamen boş bırak; aynı bölgeyi farklı bir yükseklikten ya da farklı bir girişten tut, düşman orayı kontrol etmeyi bırakınca geri dön
- **WHY** rakip hazırladığı karşı duruşu uygulayamaz; sen yeni açıdan bedava bilgi alırsın, dövüş yeniden eşit başlar
- **KANITI SÖYLE** kaç kez ve hangi round'larda olduğunu yaz ("R6 ve R9'da da orada öldün, bu üçüncüsü") — sayıyı ve round numarasını round geçmişinden AL, uydurma
...
- **IF** pozisyon, util ve bilgin net üstünlük vermediği halde sadece nişanına güvenip dövüşe giriyorsan
- **MEANING** rakip açıyı kapatmışsa, bilgin yoksa ya da util harcadıysan o dövüş eşit kapanır
- **COUNTER** dövüşten önce dur ve sor: pozisyon, util ya da bilgi bana üstünlük veriyor mu? Hiçbiri yoksa zorlamayıp geri çekil, üstünlük kurulunca dövüşü aç
- **WHY** eşit dövüş 50/50'dir, karşı taraf da iyi vurur; üstünlüğü kurmadan girmek round'u şansa bırakır

### Taktik soruna mekanik çözüm arama
...
- **COUNTER** plan tutmadığını fark ettiğin an dövüşe yüklenme; geri çekil, düşmanın yerini öğren (recon ya da ses), zamanlamayı ve açıyı kendi lehine düzelt, sonra gir
- **WHY** taktik sorunun mekanik çözümü yoktur; eşit nişanda kazanan, düşmanın yerini daha iyi bilendir

### Baskıda üç soruyu sor

- **IF** yakın maçların son round'larında daha agresif açı alıyor, util kullanmıyor, hızla içeri giriyorsan
- **MEANING** baskı altında karar kaliten düştü, otomatiğe bağladın
- **COUNTER** harekete geçmeden önce bir an dur ve üç soruyu yanıtla: util'im nerede? Kaç düşman kaldı? Elimde hangi taze bilgi var? Üçünü de yanıtlamadan içeri girme
...
- **COUNTER** düşman kredisini geçen round'un sonucundan oku: kaybettiyse force ya da yarım alım gelir — ucuz silah yakın mesafede güçlüdür, hattı uzaktan tut; kazandıysa tam silah + dolu util gelir, ilk temasa kendi util'ini indir. Düşman da yarı ekonomideyse save'e geçme, yarım alımla üstüne bas; tam silahlıysa silahı taşı. Her ajanın imza yeteneği ekonomiden bağımsız bedava gelir — "util'i bitmiştir" diye hesap yapma
...
### Kaybedilmiş dövüşü zorlama — silahı kurtar
...
- **COUNTER** dövüş aramayı bırak; tutulmayan bir açıdan spawn'a doğru çekil ve tüfeği sonraki round'a taşı; sayı aleyhine döndüğü AN peek'i kes, sadece hayatta kal
- **WHY** kurtarılan tüfek sonraki round'un tam alımıdır; ölü tüfek düşmana bedava ikinci silah demektir
- **NOT — BAŞLIKTAKİ SÖZCÜĞÜ ÇIKTIYA TAŞIMA** can/HP verisi bu sistemde YOK: ne sayısal ("41 HP") ne nitel ("düşük canla", "az canla") tek kelime yazma. Bu bloğun tetikleyicisi can değil, SAYI ve POZİSYON — dersi "sayı aleyhine döndü, dövüş çoktan kaybedilmişti; silahı taşı" diye kur
...
- **IF** clutch'ta kaybettikten sonra bir sonraki clutch'a tereddütle giriyorsan
- **MEANING** sonuç kararı yanlış göstermez: elindeki bilgiye göre doğru olan hamle, kafadan vurulduğun round'da da doğruydu
- **COUNTER** aynı durum tekrar geldiğinde planı değiştirme — tek girişli açını yine al, ilk sesi yine bekle; sadece geçen sefer eksik olan tek şeyi ekle (açıyı bir adım kaydır ya da util'i sona sakla)
- **WHY** clutch'ta tereddüt ikinci bir hata üretir; tekrarlanan doğru karar seriye yayıldığında kazanır
...
- **IF** round'un son aşamasında, spike ortada yokken, sayı net karşıdayken (iki kişi eksiksin ya da 1v3+ kalmışsın) dövüş ararken öldüysen — 1v2'de bu blok değil, "Clutch'ı 1v1 dizisine indir" geçerli. Takımın save çağrısı VERİDE YOK: "takım save dedi" yazma, dersi sayı farkına bağla
...
### Operator'ü bedavaya teslim etme

- **IF** elinde Operator varken öldüysen (loadout'unda Operator görünüyor)
- **MEANING** bu ölüm çift kayıp: takımın en pahalı silahı gitti ve yerde düşmanın alacağı hazır bir Operator kaldı — o silah artık sana karşı hat tutar
- **COUNTER** atıştan sonra aynı açıda kalma; atış, yer değiştir, yeniden kur döngüsünü hiç bozmadan işlet; yanında trade alacak arkadaş yokken açık düello arama — hattı tut, dövüşü düşman sana gelince aç
- **WHY** yaşayan Operator her round hattı yeniden kilitler; teslim edilen Operator hem ekonomiyi boşaltır hem düşmana bedava hat kilidi verir
...
- **IF** ölüm-tipi ipucu `win-streak-comfort` ise (önceki 3+ round üst üste kazanılmış — seri masaüstünden gelir, round geçmişi satırlarında kazanç/kayıp YAZMAZ)
...
- **Örnek**: Icebox'ta 4v2 öndeyken bir kill daha almak için B Site'a fazladan peek atıp 3v2'ye düştün — sayı avantajında peek arama; köşeleri kur, bekle, düşmanı sana gelmeye zorla.
...
- **IF** sayı avantajındayken beklemediğin yoldan gelen düşmana öldüysen
- **MEANING** sayısı azalan düşmanın tek dönüş yolu dağınık oyuncuları tek tek avlamaktır; boş sarma yolu ona o kapıyı açar
- **COUNTER** bir kişi sarma yolunu tutsun; kalan util'le bir girişi kapat ki düşman tek kapıya sıkışsın; kalanlar çapraz kurup beklesin, kimse tek dolaşmasın
- **WHY** tek kapıya sıkışan düşman kurduğun çaprazın içine gelmek zorunda; avlanacak dağınık hedef kalmaz

## Seri Kayıp Sonrası Round

Bu bölümü SADECE [ÖLÜM-TİPİ İPUCU] `loss-streak` derse kullan — kayıp/kazanç serisi round geçmişi satırlarında GÖRÜNMEZ (orada yalnız öldün/hayatta kaldın + yer yazar); seriyi masaüstü deterministik hesaplayıp ipucu olarak gönderir. İpucu yoksa seri VAR SAYMA, bu bölümü açma.

- **IF** ölüm-tipi ipucu `loss-streak` ise (önceki 3+ round üst üste kaybedilmiş — bunu masaüstü doğruladı; sen round geçmişinden çıkarmaya çalışma)
- **MEANING** seri tek tek düellolardan değil plan karmaşasından gelir: her round başka fikir, util zinciri kopuk, ilk ölüm erken
...
Bu bölümü SADECE skor uzatmayı gösterdiğinde ya da taraflardan biri maç sayısındayken kullan.

- **IF** skor uzatmadaysa ya da taraflardan biri maç sayısındaysa
...
- **COUNTER** smoke'u düşman öldürmek için değil, bir geçişi kapatmak için at; round boyunca o geçişi kapalı tut; düşman geçerse sesini duyarsın, geçemezse başka yola yönelir — iki durumda da yerini öğrenirsin
- **WHY** düşman o açıdan geçemeyince nereye gittiğini takım okur, harita üstünlüğü ve dövüş seçimi sana geçer
...
- **COUNTER** site'a koşmadan önce en az bir util hazırla; girişe smoke atıp görüşü kes ya da içeri flash atıp kör et, util etki ettiği AN gir; ekonomiyi round başında takımla aynı karara bağla
- **WHY** util girişi örter ve düşmanı kör eder, sana temiz bir giriş açar; erken round'larda bedava bilgi vermemek kazandırır

### Savunma pistolünde mesafeni sen seç
...
Spike kurulu ve saldırıdasın: spike senin için sayıyor, acele etmek zorunda olan taraf düşman. Derin taktik (plant spotu, util sırası, oyuncu sayısına göre plan) spike kuruluyken prompt'a giren POST-PLANT PLAYBOOK bloğunda — detayı oradan al.
...
- **MEANING** post-plant'ta peek atan taraf zamanı kendi aleyhine çevirir; sen yerinde durdukça round zaten senindir
- **COUNTER** post-plant'ta peek arama; spike senin için sayıyor — defuse başlama sesini ya da ilk kontağı bekle, util'ini defuse'u bozmak için sakla
- **WHY** defuse sesi düşmanın yerini bedavaya söyler; sakladığın util tam o anda inerse hem defuse'u hem sayıyı birden bozar

### Sayı azken uzak açıya çekil

- **IF** spike kurulu ve sayıca azken (1v2, 2v3) site içinde tutuş verirken öldüysen
- **MEANING** site içinde sayıca azken retake'in util'i ve çapraz ateşi aynı anda üstüne gelir; dövüşü onların kurduğu yerde vermiş olursun
...
- **WHY** sayıca azken kazandıran kill değil zamandır; hayatta kaldığın her an spike lehine işler, uzak açıdan tek atış defuse'u iptal ettirir

### Spike'ın dibinde bekleme

- **IF** spike'ın hemen üstünde ya da bitişik köşede beklerken öldüysen
- **MEANING** retake yapan herkesin crosshair'i önce spike'a bakar; dibinde duran oyuncu ilk taranan yerdedir
- **COUNTER** spike'ı GÖREN ama spike'ta OLMAYAN bir köşeye geç — mesafeyi sen koy, ilk atışı ver, tek adımda kapan
- **WHY** mesafe sana ilk atış ve bir adımlık çekilme hakkı verir; spike'ın dibindeki oyuncu ilk mermide hem sayıyı hem spike'ı teslim eder
...
- **COUNTER** spike kurulunca bir kişi sarma yolunu tutsun; tek başınaysan sırtını duvara ver, girişi ve sarmayı tek dönüşle gören köşeyi seç; ayak sesi arkadan gelirse açını önce oraya çevir
- **WHY** sarma kapalıysa retake tek kapıya sıkışır; arkası boş post-plant iki yöne bölünüp düşer
...
### Sayı sende değilse retake'e girme — silahları taşı

- **IF** spike kurulu, savunmadasın ve sayıca azken (1v3, 2v4) yine de siteye koştuysan
- **MEANING** o retake matematik olarak kayıp; ölünce tüfeğin de düşmana kalır, sonraki round'un ekonomisi çöker
- **COUNTER** retake'i bırak; tutulmayan yoldan uzaklaş, düşman siteden çıkmadıkça dövüş arama, silahı sonraki round'a taşı; iki kişiyseniz karar ortak olsun — ya birlikte girin ya birlikte taşıyın
- **WHY** kurtarılan iki tüfek sonraki round'u tam alıma çevirir; umutsuz retake iki round birden kaybettirir

### Yarım defuse'la util'i boşa attırt
...
- **IF** spike kurulu, son savunmacı senken birden çok düşmana karşı siteye tek girip öldüysen
- **MEANING** tek kişi köşeleri temizleyip defuse'u koruyamaz; o giriş round'u getirmez, tüfeğini de hediye eder
...
- **IF** lurk hattında koşarak ilerlerken ya da fark edildikten sonra aynı hatta kalıp öldüysen
- **MEANING** lurk'ün değeri görünmezliktir; ayak sesin duyulduğu an artık lurk değil, desteksiz bir 1v2'sin
- **COUNTER** lurk hattında hep yürü, takımın ilk teması başlamadan ateş açma; fark edildiysen — sana dönen ayak sesi, üstüne atılan util — hattı bırak, takıma doğru çekil, aynı köşede bekleme
- **WHY** keşfedilen lurk düşmana bedava sayı verir; çekilen lurker bilgiyi taşır, sonraki basışta yeniden görünmez olur

## Ölüm Tipini Doğru Eşle

[ÖLÜM-TİPİ İPUCU] / [DEATH-TYPE HINT] varsa tipi ORADAN al, kendin türetme. Aşağıdaki eşleme SADECE ipucu YOKSA geçerlidir — o durumda tipi killerInfo, deathLocation, side ve score'dan türet.
...
- **Kaybedilmiş dövüşü zorlama** (sayı/pozisyon net aleyhteyken dövüş arama) → Karar ve Ekonomi bölümündeki "Kaybedilmiş dövüşü zorlama — silahı kurtar" başlıklı blok. Can/HP verisi YOK: metne can durumu yazma, dersi sayı ve pozisyona bağla.
...
- **Savunmada trade'siz ölüm** (def-no-crossfire) → Pozisyon ve Açı Ölümleri — Crossfire kur, yan yana durma.
- **Savunmada geniş/erken açı tutuşu** (def-wide-hold) → Pozisyon ve Açı Ölümleri — Açıkta değil, siperin yanında dur.
...
- **Seri** (yalnız [ÖLÜM-TİPİ İPUCU]'ndan gelir — geçmiş satırlarında kazanç/kayıp YAZMAZ): `loss-streak` → Seri Kayıp Sonrası Round; `win-streak-comfort` → Kazanma serisinde bonus baskınına hazır ol.

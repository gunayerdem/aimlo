...
B Main'de dar alanda yığılmak seni öldürür. Üçünüz aynı anda girmeye kalktığınızda savunucu tek spray'de hepsini alır. Sırayla girin: ilk kişi flash ile girer, ikinci kişi trade pozisyonu alır — üçüncü girene kadar açı temizlenir.
...
Catwalk bir geçiş noktası, kamp yeri değil. Saldırıda: kontrol etmeden girersen Market'ten çıkan biri seni keser. Savunmada: çok uzun kalırsan util ile çıkarılırsın. Bilgini al, pozisyonunu değiştir.
...
**WHY:** A site'in avantajı Heaven yüksekliği ve Generator arkası. Bu ikisini util ile kapatırsan site alımı artık mekanik testi değil — koordinasyon testi olur. Koordinasyonu iyi olan takım, mekanik olarak iyi olan bireyi yener.
...
- Sentinel util'i (tel, bot) ile Market girişini kapat.
- B Main'de yığılma — oyuncular arasında mesafe bırak.

**WHY:** Dar alan her iki taraf için de çift taraflı keser. Savunucu için avantaj çünkü tek spray ile birden fazla kişiyi vurabilir. Ama aynı darlık savunucunun kaçış yolunu da keser — util ile pozisyonundan çıkarırsan gidecek yer bulamaz. Flash + smoke dar alanlarda açık alana kıyasla daha güçlü çalışır.
...
**COUNTER:** Top Mid'de op varsa oraya kuru peek atamazsın. Flash + swing ikilisi kullan ya da smoke ile op'un sightline'ını kapat. Mid'i aldıktan sonra takımla iletişim kur — sen Market'tesin ama takım hâlâ A Main'deyse yalnız kalırsın.
...
**IF:** Mid kontrolünü aldıktan sonra bir grup A Short'tan, diğer grup A Main'den aynı anda site'a giriyor. (B için: Market + B Main.)

**MEANING:** Savunucuyu iki yönden aynı anda baskıya alınca crossfire kurması imkânsızlaşır. Ya A Main'e bakar ya A Short'a — ikisine birden bakamaz.
...
**WHY:** Savunmanın en büyük avantajı nereden geleceğini bilmesi. Split bunu yok eder. İki yönden aynı anda tehdit geldiğinde biri önceliklendirilir, diğeri ihmal edilir — split tam olarak bunu hedefler.
...
**MEANING:** A site savunmasının temeli Heaven. Tüm site'i görürsün, saldırganların ilk smoke'laması gereken yer burası. Generator, Heaven'a alternatif bir off-angle — saldırgan Heaven'ı smoke'layıp Generator'u kontrol etmezse arkadan yer. Wine (Tree altı) clutch ve retake için gizlenme noktası.

**COUNTER:** A site savunmasında en büyük hata şu: her round aynı yerde duruyorsun. 3-4 round sonra saldırgan açını tutar, öldün gitti. Her round pozisyon değiştir — bir round Heaven, sonraki Generator, sonraki Wine. Saldırgan hangi açıya bakacağını bilemez.

**WHY:** Aynı yerde duruyorsan bilgi veriyorsun. Bilgi Valorant'ta en değerli şey. Pozisyon değiştirince saldırgan her round birden fazla açıyı kontrol etmek zorunda kalır, giriş hızı düşer.
...
**COUNTER:** Anchor olarak agresif peek atmayı kes. Görevin şu: saldırganı yavaşlatmak ve takıma bilgi vermek. Her round peek atıp ölüyorsan, molly ya da tel ile B Main'i yavaşlat, açıya çıkma. Hayatta kalmak bilgi vermekten bile daha değerli — retake için sayı avantajını koruyorsun.

**WHY:** B site dar. Sen ölünce site anında açılır. Market'ten retake zaman alır, o sürede saldırgan spike'ı plant edip post-plant pozisyonu alır. Anchor hayatta kalırsa saldırganın plant süresi kısalır, retake şansın artar.
...
**IF:** Site kontrolünü kaybettin — spike plant edildi, saldırganlar post-plant pozisyonunda.

**MEANING:** Retake Ascent'te en zor ama en ödüllendirici durum. A site retake'inde Heaven + Generator + A Main'den aynı anda üç farklı açıdan girersin, saldırgan tüm açıları tutamaz. B site retake'inde Market + CT çıkışı + Closet yönlerinden koordineli giriş şart.
...
**Fade:** Recon ve bot ile yakın mesafe bilgi toplama ve entry desteğinde Sova'dan güçlüsün. Ama Ascent'in uzun sightline'larında recon daha fazla alan görür — bu yüzden Sova'nın biraz gerisinde durursun.
...
### A Site ve Çevresi
- **A Main / A Lobby:** A site'e giden ana koridor. Burada yavaş yürü — op çekiyor, uzun sightline var.
...
### Mid
- **Mid Top / Top Mid:** Mid'in savunma tarafı. Op sightline'ı — kapalı kapı yoksa kafanı çıkarma.
...
**MEANING:** A site post-plant'te savunucu sana üç yönden gelir: Heaven, A Main ve CT. Generator arkası plant iyidir çünkü oradan spike'ı izleyebilirsin. Post-plant pozisyonları:
- A Main'e bak — retake'i erkenden gör
- Generator arkası — spike'ı izle
- A Short — Heaven'dan geleni kes

**COUNTER:** Herkes A Main'e yığılıyor, sonra savunucu Heaven'dan giriyor ve spike'ı rahat defuse ediyor. Kimse Heaven'a bakmadığı için. Çözüm basit: dağıl. Bir adam A Main, bir adam A Short/Catwalk, bir adam site içi. Crossfire kur — retake tek yönden geldiğinde iki açıdan vuruyorsunuz.

**WHY:** Spike plant'tan sonra zaman senin için çalışıyor. Savunucu sana gelmek zorunda — sen peek açmak zorunda değilsin. Gereksiz peek atarsan bu avantajı çöpe atarsın. Pozisyonunu tut, savunucuyu sana gelmeye zorla. O peek atmak zorunda — bu duel zaten senin lehine.
...
**MEANING:** B site post-plant'te asıl tehdit Market rotasyonu. Savunucu Market'ten ve CT'den gelir. B Main'den retake daha nadirdir. Post-plant pozisyonları:
...
Tek başına force buy yapma — takımın ekonomisini mahvedersin. Eco'da B rush ya da Market üzerinden mid push yap, yakın mesafe senin arkadaşın. Force buy yapacaksan herkes aynı seviyede silah alsın:
- İki kişi Spectre, üç kişi Classic? Bu force buy değil, para çöpü.
- Sheriff ile op'çuya mid'den agresif bak, headshot vurursan round döner.
...
**IF:** Düşman son 3 round'da aynı site'a girdi — mesela 3 kez üst üste A'ya execute yaptı.
...
- Flash at, swing at — reaksiyon avantajını elinden al.
- Farklı rotadan git — op A Main'deyse B'ye geç veya mid'den split yap.

**WHY:** Op görüş hattına bağımlı. O hattı kapatırsan 4700 kredilik silah duvara bakar. Silahı değil, görüş hattını devre dışı bırakıyorsun.

---

### Sentinel Kurulumlarını Kırma

**IF:** Düşman Killjoy veya Cypher her yere tuzak, tel, bot kurmuş.

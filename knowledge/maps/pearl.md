...
- Görüş hatları orta-uzun mesafe. Vandal da Phantom da iş görür ama Mid Plaza ve B Main'de Op ağır basar.
...
- 2 kişi B Main — B Hall'u tut, bilgi al.
...
COUNTER: Art'ı flash + peek ile temizle. A Dugout ve A CT'yi smoke'la. A Main'den gir, A Link'ten destek ver, crossfire kur. Spike'ı A Default'a (kutuların arkasına) bas. Post-plant: A Main + A Link crossfire.
...
MEANING: B'ye dön. B Main'i alarak site'a gir.
COUNTER: B Main'e smoke ile gir. B Hall CT tarafını ve B Screen'i smoke'la. B Main + B Link'ten aynı anda push at. B Tower ve Screen'deki off-angle'ları temizle. Spike'ı B Default'a bas.
...
- A: 1 kişi A Dugout, 1 kişi A Art ya da A Main girişinde.
- Mid: 1 kişi Plaza/Shops.
- B: 1 kişi B Screen/Hall, 1 kişi B Main/Ramp.
...
COUNTER: B Screen'den site'ı tut, B Tower'dan geniş açı al. B Main'de erken agresyon bilgi verir ama risklidir — bilgiyi al, geri çekil. B Link'i her zaman gözle; Mid'den gelebilirler.
...
COUNTER: Plaza'da util ile alan kapat — smoke, molly, tuzak. Connector'dan A Link'i koru. Agresif Mid peek bilgi verir ama ölürsen Mid'i teslim edersin; peek at, bilgiyi ver, geri çekil.
...
- **Harbor**: B Main'i duvarla kapat ve aynı anda push at. Başka hiçbir controller bunu yapamaz. Smoke ile spike'ı koru, duvarla Mid'i böl.
...
- **B Tunnel**: B site yanındaki dar geçit. Rotasyon ve flank için kullanılır.
...
- **Mid Shops**: Plaza'nın B tarafı. B Link'e buradan geçilir — gizli mid-to-B split rotası.
- **Mid Connector**: Plaza'nın A tarafı. A Link'e ve savunucu su odasına buradan bağlanılır.

...
IF: A Belt'e smoke veya flash atmadan giriyorsun — o uzun görüş hattına korumasız çıkıyorsun
...
COUNTER: B execute planlanıyorsa Tube'a bir oyuncu gönder veya girişe sentinel utility'si koy — tel, turret veya alarm botu. Tube'u boş bırakmak B site'i tek boyutlu kılar. Saldırı tarafında Tube kontrolü = B site'e iki yönlü baskı.
...
## 6. Ajan Notları
- **Sova (S-tier)**: Sova için en iyi harita burası. Recon oku ile A ve B site'ı geniş açıdan tararsın; hasar oku lineup'ları her iki site için çalışır. Drone'u Tube ve Mid'e sok, düşmanın yerini öğren. Ult'u dikey yapıda da güçlü — A Rafters'taki oyuncuyu yerden vurursun.
- **Viper (S-tier)**: Duvarın A veya B site'ı ikiye böler. A'da Rafters'ı site'tan kesersin — savunucunun avantajı gider. B'de Yellow'u izole edersin — o iç içe yapı sadeleşir. Molly lineup'ların dar plant bölgelerinde defuse'u durdurur; duvar + molly post-plant ikilisi bu haritada korkunç güçlü. Ult'un A site'ın açık yapısında tam alan kontrolü verir.
...
- **Jett (A-tier)**: Op alıyorsan Jett seç. A Belt, Mid ve A Pipes uzun görüş hattı sunuyor. Zıplamayla Rafters'a ve yüksek noktalara çıkarsın — başka hiçbir duelist o dikey hareketi yapamaz. Agresif peek sonrası dash'le çekilirsin — Mid ve Belt'te bu seni kurtarır.
- **Killjoy (A-tier)**: Turret + alarm botu iç içe B yapısını senin için tutar. Molly'ni B Orange ve A Belt girişine göm, rush durur. Ult'unla B'ye basan saldırganları site'tan söküp atarsın — retake'te büyük avantaj. Killjoy'un değerinin büyük kısmı B site'a özel, bunu bil.
...
- **KAY/O (B-tier)**: Yetenek kapatan bıçağın burada değerli — Viper'ın aktif duvarını ve bulutunu bıçakla kapatırsın. Sage duvarı fizikseldir, suppress'ten etkilenmez — onu vurarak kır. Flash'ların dar koridorlarda işe yarar, molly'ni post-plant için kullanırsın. Ama düşman yerini öğrenmede Sova seni geride bırakır.
...
- **Eco round**: A Pipes'ta Sheriff oyna. Kafadan tek atışla düşmanın silahını alırsın. B'deysen Orange içinde Judge tut, çıkışları kes.
...
COUNTER: Tube girişine sentinel utility göm — tel, turret, alarm botu. Sova ya da Fade recon'u ile mid'den erken bilgi al. Bilgi gelince pozisyon al, sürpriz kalmaz.
...
COUNTER: Sage duvarı + Killjoy ult'u varsa Orange girişini kapat, site'a girenleri geri çevir. Bu ikisi yoksa molly + yavaşlatma at — rush'ı yavaşlatır, rotasyon zamanı kazanırsın.
...
- **B Orange**: B site'e ana giriş. Turuncu ışıklı bu koridorda sıkışırsan çıkamazsın, util kullanmadan girme.

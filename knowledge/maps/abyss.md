...
- Op'la mid'i kilitle, kimseyi geçirme.
- Flash'la içeri gir, açıyı temizle.

Mid kontrolün yoksa saldırın tek boyutlu kalır. Savunmada da rotate'ini kaçırırsın.
...
MEANING: Smoke ve flash yok. A Tower'daki savunan + site içindeki anchor seni açık koridorda görüyor. A Security de temizlenmemiş.
COUNTER: Smoke: A Tower + A Security çıkışı. Flash: A Main'den site'a doğru at — flash patladığı an entry oyuncusu swing atar. A Security temiz değilse girme, crossfire yersin. Mid'den A Link üzerinden split ikinci fazı kurar. Spike: A Default, uçurumdan uzak.
...
IF: Takım mid'i almadan site execute yapıyor — mid rakibe bırakılmış.
MEANING: Mid gitmişse rakip rotate hızını kendi belirler, split'ini engeller, saldırın tek boyutlu kalır.
...
IF: Util'siz mid'de duruyorsun — ya duel'i kaybediyorsun ya uçurumdan düşüyorsun.
MEANING: Mid, Abyss'in en yoğun çatışma noktası. Util olmadan her duel 50-50, bir de uçurum riski var.
COUNTER:
- Duvar çekip mid geçişini kapat. Bu haritada mid savunması için en güçlü araç bu.
- Smoke ile geçişi geciktir.
- Op tutuyorsan, peek sonrası geri çekilirken arkanda uçurum olduğunu unutma.

WHY: Mid kontrolü rotate güvenliğini belirler. Mid savunanı düşerse, mid'den dönen takım arkadaşı açık kalır. Util ile gecikmeli tut — takımına rotate zamanı kazandırırsın.
...
- "Mid geçişine çektiğin duvar, haritanın en güçlü tek util hamlesi. Duvarı boşa harcama — round planına göre at."
...
- **B Main**: B site'a giden ana koridor. Choke noktası — util olmadan buraya dar girme.
...
**Mid Bölgesi**:
- **Mid Top**: Mid'in üst şeridi, A tarafına yakın.
- **Mid Bottom**: Mid'in alt şeridi, B tarafına yakın.
- **Mid Library**: Mid'in yan geçiş bölgesi.
- **Mid Catwalk**: Mid'i siteye bağlayan dar geçiş.
- **Mid Bend**: B Main'den ascender ile çıkılan mid kıvrımı. Mid kontrolünün anahtar noktası.

**Genel**:
- **Defender Spawn**: Savunan spawn noktası.
...
IF: Spike B site'ta plant edildi, takım B Main'e çekildi — dar geçitten savunma.
MEANING: B Nest ve B Link'ten retake gelir. B Main'de duruyorsan dar geçit seni sıkıştırır, avantaj savunanda olur.
COUNTER: B Main + B Link'te crossfire kur. B Tower'ı smoke'la ya da molly'le kapat. B Nest'i tek oyuncu izlesin. Spike'ı B Default'a — site ortasına — plant et. Dar geçitlere yığılma, crossfire açısı veren noktalara geç.
...
**Silah Tercihleri**: Vandal al. A site ve mid'deki uzun mesafelerde Phantom yetersiz kalır, Vandal'ın hasarı düşmez. B site savunmasında Phantom kabul edilebilir — orada mesafeler kısa.

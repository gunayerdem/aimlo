...
Bridge bu haritanın kalbi. Bridge'i alan takım A'ya da B'ye split atar, rotate hızını yönetir, rakibin hareket alanını daraltır. Bridge kavgası neredeyse her round çıkar.

Bridge'e yaklaşırken üç seçeneğin var:
- Duvar çekip Bridge'i kapat, geçişi engelle.
- Op'la Bridge'i kilitle, kimseyi geçirme.
- Flash'la içeri gir, açıyı temizle.

Bridge kontrolün yoksa saldırın tek boyutlu kalır. Savunmada da rotate'ini kaçırırsın.

## 2. Ölüm Bölgeleri

**A Main / A Ramp**: A site'a giren ana koridor ve rampa. Savunanlar A Heaven'dan ve A Site içinden bu koridoru tutuyor. Burada ölüyorsan, util atmadan kuru giriyorsun ya da A Ramp'ta dur-bak-ilerle yapmadan akıyorsun. A Main'de arka arkaya ölüyorsan, giriş util'ini kullanma alışkanlığın yok demektir.

**B Lane / B Lobby**: B site'a giden dar geçiş. Savunan dar açıda bekliyor, sen arkadaşınla üst üste giriyorsun — ikinizi de bitiriyor. Stagger girmeden akarsan, savunana bedava çoklu frag verirsin.

**Bridge (Mid)**: Haritanın en kalabalık çatışma noktası. Op burada çok güçlü ama uçurum her an yanında. Bridge'de tekrar tekrar ölüyorsan şu ikisinden biri:
...
COUNTER: 2-1-2 ile aç. 2 kişi A Main/Ramp'te bilgi toplar, 1 kişi Bridge'i tutar, 2 kişi B Main/Lobby'de bilgi alır. Rakibin B'de tek kaldığı anlaşılınca commit et. Bridge'deki oyuncu split yönüne geçer.
...
WHY: A site geniş. Util olmadan savunan her açıdan ateş açar. Smoke sightline'ı keser, savunanı tek karar noktasına sıkıştırır. Flash tepki avantajını sıfırlar.
...
WHY: Dar geçişte savunan nişanını değiştirmek zorunda kalmıyor çünkü herkes aynı sightline'a giriyor. Stagger ve split onu iki açıyla uğraşmaya zorlar.

**Pattern 4: Mid Bridge Control**

IF: Takım Bridge'i almadan site execute yapıyor — mid rakibe bırakılmış.
MEANING: Bridge gitmişse rakip rotate hızını kendi belirler, split'ini engeller, saldırın tek boyutlu kalır.
COUNTER: Round başında 1 oyuncu Bridge'e smoke ya da flash gönderir. Bridge alındıktan sonra split yönü belirlenir. Bridge'de Op güçlü ama uçurum yakınında durma. Duvar gecikme ve kontrol için iyi bir seçenek.
WHY: Bridge'i tutan takım rakibin rotate süresini uzatır ve split açar. Bridge gidince savunanlar rahatça stack yapar. Abyss'te mid kontrolü round temposunu belirler.
...
IF: Her round aynı pozisyonda, A Heaven'da duruyorsun — rakip açını tutup ilk atışta indiriyor.
MEANING: A Heaven güçlü bir pozisyon. Ama aynı yerde durursan rakip seni ezberler. Sana ulaşmadan kafasını oraya çevirip geliyor.
COUNTER:
...
WHY: Off-angle, rakip onu beklediği an işe yaramaz. Pozisyon değiştirirsen rakip her round birden fazla açıyı kontrol etmek zorunda kalır. Bu onu yavaşlatır ve hata yaptırır.
...
- B Lane'de erken aggression yerine sentinel util'i koy — tel ya da tuzak bilgiyi sana getirir.
- B Back'te off-angle oyna. Retake'e gelen rakip seni göremez.

WHY: Kompakt site'larda anchor ölürse site düşer. B site'in sınırlı girişleri senin lehine — ama sadece sen hayattayken. B Lane'den gelen tek bir kill, anchor rolünün sana verdiği site kontrolünden daha az değerli.

---

**Pattern 3: Bridge Savunma**

IF: Util'siz Bridge'de duruyorsun — ya duel'i kaybediyorsun ya uçurumdan düşüyorsun.
MEANING: Bridge, Abyss'in en yoğun çatışma noktası. Util olmadan her duel 50-50, bir de uçurum riski var.
COUNTER:
- Duvar çekip Bridge'i kapat. Bu haritada Bridge savunması için en güçlü araç bu.
- Smoke ile geçişi geciktir.
- Op tutuyorsan, peek sonrası geri çekilirken arkanda uçurum olduğunu unutma.

WHY: Bridge kontrolü rotate güvenliğini belirler. Bridge savunanı düşerse, mid'den dönen takım arkadaşı açık kalır. Util ile gecikmeli tut — takımına rotate zamanı kazandırırsın.

---

**Pattern 4: Void Savunma (Kenar Kontrolü)**
...
- "Bridge'i verme. Bridge'i kaybettiğin anda haritanın yarısını kaybedersin — rakip seni istediği yere böler, sen sadece tepki verirsin."
...
- "Bridge'e çektiğin duvar, haritanın en güçlü tek util hamlesi. Duvarı boşa harcama — round planına göre at."
...
- **A Ramp**: A Main'den site'a çıkan rampa. Burası temizlenmeden execute başlatma.
...
- **A Edge (Void tarafı)**: Site'in uçurum kenarı. Off-angle sürprizi için saklıyorsun, her round açma.
- **A CT**: Savunanların A site'a ulaştığı geçiş.

**B Tarafındaki Callout'lar**:
- **B Main**: B site'a giden ana güzergah.
- **B Lobby**: B Main'in açıldığı alan. Execute öncesi takım burada toplanır.
- **B Lane**: B site'a giden dar geçiş. Choke noktası — util olmadan buraya girme.
...
- **B Edge**: Site'in uçurum kenarı. Off-angle ama risk yüksek — yanlış adım atarsan düşersin.
...
**Genel**:
- **CT Spawn**: Savunan spawn noktası.
- **T Spawn**: Saldıran spawn noktası.
- **Void**: Harita kenarlarındaki uçurum. Düşersen ölürsün — kenar pozisyonlarında mesafeyi kafana koy.

**Pozisyon Kullanım Rehberi**:

A site savunuyorsan: Round açılışında A Ramp'ta bilgi al. İlk temas olduktan sonra A Heaven ya da A Site seviyesine çekil. Aynı pozisyonda üst üste oturma — pozisyonu değiştir. A Edge'i sürpriz olarak saklıyorsun, her round açma.

B site savunuyorsan: B Heaven'dan anchor oyna. B Lane'i sentinel util'iyle izle, agresif peek atma. B Back off-angle'ını retake için saklıyorsun — erken açarsan sürpriz değerini kaybedersin.

Bridge tutuyorsan: Duvar ya da smoke ile rakibi geciktir. Op varsa elinde, uçuruma mesafeni koru — peek sonrası geri çekilme yönün kapalı olmasın. Bridge kavgasını kaybetsen bile bilgiyi takıma ver ve hayatta kal.
...
MEANING: Savunanlar CT ve A Link'ten retake atar. Tek açıdan beklersen, savunan tek bir smoke'la seni kör eder.
COUNTER: A Main + A Link'te crossfire kur. A Heaven'ı smoke'la — savunan yukarı çıkıp sizi ezmesin. Spike'ı uçurumdan uzağa plant et: defuse'a gelen oyuncu tahmin edilebilir bir noktaya gitmek zorunda kalır, crossfire'ın çalışır. Brimstone molly'si ya da Viper molly'si direkt spike üzerine.
...
MEANING: B Back ve B Link'ten retake gelir. B Lane'de duruyorsan dar geçit seni sıkıştırır, avantaj savunanda olur.
...
WHY: B site'in kapalı yapısı A'dan farklı çalışır. Molly ve yavaşlatma burada çok güçlü — defuse'a gelen oyuncunun kaçacak yeri yok. Crossfire yine temel prensip ama mesafeler kısa, tepki penceren dar.
...
**Eco Round Stratejileri**: Eco'da Bridge'de Sheriff oyna. Kenar pozisyondan tek atışla kill alırsın. Judge ya da Bucky alıyorsan uçurum kenarına yaklaşma — silahı kullanamadan düşersin. Eco'nun amacı:
- 1-2 kill al
- Silah topla
- Tamamen yok olma

**Silah Tercihleri**: Vandal al. A site ve Bridge'deki uzun mesafelerde Phantom yetersiz kalır, Vandal'ın hasarı düşmez. B site savunmasında Phantom kabul edilebilir — orada mesafeler kısa.
...
**Rakip her round A rush yapıyorsa**: A Ramp'a util dök: flash + molly + slow. A Heaven'da crossfire kur. A Main'e smoke at, push'u yavaşlat, trade al. Bridge kontrolünü elinde tut — Mid'den A Link üzerinden rotate gelsin.

**Rakip B split yapıyorsa**: B Lane'e sentinel util koy: tuzak + tel. Bridge kontrolünü artır, split'in ikinci kolu oradan geliyor. B Heaven'da anchor tut. B Lane push'unu tek başına durdurmaya kalkma — util ile geciktir, rotate bekle.
...
**Rakip Op Bridge'de dominant oynuyorsa**: Bridge'e smoke at, Op'un sightline'ını kes. Flash'la salla, flash sonrası peek at. Jett dash ya da Raze atlamasıyla hızlı geç, Op'un scope açmasına fırsat verme. Op oyuncusu aynı açıyı tutuyorsa off-angle'dan peek at.

...
COUNTER: B Arcade'yi her zaman B Main push'u ile birlikte kullan. Ana grup B Main'den baskı yaparken sen Arcade'den savunucunun odağını bölüyorsun. Arcade'ye girmeden önce B Main'deki takım hazır mı onayla. Raze oynuyorsan satchel ile hızlı giriş yapabilirsin ama yine de Main'den eş zamanlı baskı şart.
...
COUNTER: Bir oyuncu mid/CT Spawn için sorumluluk alsın. Bu oyuncu her iki site'a bilgi taşır, zip kullanımını izler. Cypher cam veya Fade haunt bu bölge için çok değerli. Rotate yapan oyuncu bile arkasını kapatmadan hareket etmesin.
...
## 7. Rank Modülasyonu
- **Iron-Silver**: Fracture'in çifte giriş yapısını anlaman lazım. Tek taraftan push etme, zip line'a hiç bakmama — bunları bırak. Kural şu: her site'a iki yol var. Sen A Dish'ten giriyorsan takım arkadaşın A Hall'dan girmeli. Savunmada da aynı mantık: iki giriş var, birini utility ile kapat, diğerini tut.
- **Gold-Platinum**: Split yapmayı biliyorsun ama bir taraf erken giriyor, diğer taraf geç kalıyor. Bu durumda split değil, iki ayrı 1v5 olur. Çözüm: ortak bir sinyal belirle — flash sesi, sesli call, fark etmez — ve aynı anda commit edin. Savunmada over-rotate yapıyorsun; bilgi gelmeden rotate etme. Zip line'ı kullan ama arkanda utility desteği olmadan atma.
- **Diamond-Ascendant**: Her raund aynı A split'i yapıyorsan rakip seni okur ve 3 kişiyi A'ya yığar. A fake göster, B'ye dön. Zip line ile giriş zamanını değiştir. Post-plant crossfire pozisyonlarını çeşitlendir. Rakip seni okumaya başladıysa strateji değiştir — aynı şeyi tekrar yapma.
- **Immortal-Radiant**: Her raund rakibin default'unu oku ve exploit et. Zip line zamanlamanı çeşitlendir. Aynı stratejiyi arka arkaya iki raund kullanırsan rakip zaten hazır bekler. Post-plant lineup'larını sapma payı olmadan uygula. Raund bazında anti-strat yap — bir önceki raundda ne işe yaradıysa bir sonrakinde rakip buna karşı hazırlanmış olabilir.
...
- Raze kullanıyorsan: Boombot'u Tower'a gönder, bilgi topla; sonra satchel ile Arcade'den hızlı giriş yap.
- Spike plant: B Default, kutuların arkası. Plant sonrası B Main + B Arcade crossfire kur.

### B Site Savunma
- B Tree en güçlü anchor noktası. Hem Tower hem Main girişini buradan izlersin, cover var, açı geniş.
...
- B Arcade ikincil girişi kapatmanın anahtarı. Tripwire veya turret buraya çok iyi oturur.
...
- **Cypher**: Tripwire çifte girişin birini kontrol ediyor. Spycam uzaktan bilgi veriyor. Ama Fracture'in agresif saldırı temposu Cypher'in pasif kurulumunu zorluyor.
- **Skye**: Flash dar girişlerde işe yarıyor ve bilgi geri dönüyor. Trailblazer koridoru temizliyor. Ama Breach burada Skye'den çok daha fazla iş yapıyor, seçim yapmak zorunda kalırsan Breach al.
- **Viper**: Toxic Screen Fracture'da çalışıyor ama haritanın yapısı Viper'i diğer haritalardaki kadar güçlü bırakmıyor. Snake Bite spike sonrası savunmada hâlâ sert.
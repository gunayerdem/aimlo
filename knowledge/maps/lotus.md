...
MEANING: Saldırıda tek boyutlu giriyorsun — defender tüm odağı A Main'e veriyor. Savunmada Drop'u kontrol etmemek sessiz bir flanker'ı içeri davet eder.
COUNTER:
- Saldırıda: 1 kişiyi Drop'tan sessiz gönder, takım A Main'den execute etsin — crossfire kurarsın.
- Savunmada: Drop altına tel, tuzak ya da bot koy. Yoksa Drop'u sürekli peek etmek zorunda kalırsın ve A Main'e karşı açık kalırsın.
WHY: Silent Drop ses çıkarmadan site girişi sağlar. Diğer tüm girişlerde ayak sesi ya da ability sesi var — Drop bunları geçer. Savunmada kontrol edilmezse defender'ın arkasına biri düşmüş demektir, oradan kurtulmak neredeyse imkânsız.
...
MEANING: 3 siteli haritada en büyük tuzak budur. Attacker A'da ses çıkarıp C'ye execute eder — 3 kişin A'ya gittiyse C'de kimse kalmaz. Fake'lere düşersin.
COUNTER:
...
WHY: 3 siteli haritada her site'ta en fazla 2 kişi var. Biri gidince 1 kişi kalır. Bilgiye dayanmayan rotate attacker'a tam istediğini verir: boş site.
...
**Pattern 9: Mid Kontrolünü İhmal Etmek**
IF: Takım mid'e ne util ne oyuncu gönderiyor.
MEANING: Mid A'ya, B'ye ve C'ye bağlanır. Boş bırakırsan attacker mid üzerinden her yöne split yapar, sen rotasyon için mid'i kullanamazsın.
COUNTER:
- En az 1 kişi mid'e baksın ya da sentinel util ile kapatsın.
- Saldırıda: Mid kontrolü split execute seçeneklerini açar.
- Savunmada: Mid Link'e tel ya da tuzak koymak bile yeterli.
...
- Kırılabilir duvarı her round aynı noktada kırmak — defender bir kez görünce seni okur, hazır bekler.
...
- Döner kapı sesini duyduğunda tepki ver — o ses doğrudan rotasyon sinyali. Görmezden gelirsen karşı taraf bedava site alır.
...
- "Spike dikildikten sonra aynı pozisyonda bekleme. Kapıyı kullan, pozisyon değiştir — yoksa defender'a bedava retake verirsin."
...
### Iron-Silver
Döner kapının farkında bile değilsin. Kırılabilir duvarı ya hiç kırmıyorsun ya da her round panikle kırıyorsun. Silent Drop'u duymamışsın bile. Şimdi tek hedefin var: bu üç mekaniği tanı ve her birini en az bir kez kullan — kapı, duvar, drop. Bu kadar. Bunu yapman bile seni bir adım öne taşır. Bir de şunu bil: 3 site arasında nereye gittiğini bilmiyorsun. Callout'ları öğren, rotasyonun otomatik hızlanır.

### Gold-Platinum
Mekanikleri biliyorsun ama yanlış kullanıyorsun. Duvarı round başında kırıyorsun — execute anında kır. Kapıdan tek başına geçiyorsun — takımınla koordine et. Silent Drop'u rastgele kullanıyorsun — A execute planına bağla. Savunmada da şu var: sahte baskıya kanıp tüm takım rotate ediyor. Bilgi olmadan rotate etme. Gerçek bilgi gelene kadar yerinde dur.

### Diamond-Ascendant
Mekanikleri ve stratejiyi biliyorsun ama her round aynı şeyi yapıyorsun. Rakip seni okudu. Kapı stratejini değiştir. Duvarı farklı anlarda kır. Post-plant pozisyonlarını dönüşümlü al — kapı, sonra içeri, sonra tekrar kapı. Mid kimin elindeyse split execute ve rotasyon avantajı onun. Mid kontrolünü hafife alma.

### Immortal-Radiant
Her şeyi biliyorsun. Farkı yaratan şey round bazında okuma. Rakip hangi girişi tercih ediyor, hangi mekaniği kullanıyor — bunu oku ve setup'ını ona göre ayarla. Rakip kapıyla rotate ediyorsa kapı yakınına sentinel util bas. Kullanmıyorsa kapı tarafını hafif tut, diğer girişleri güçlendir. Kapı fake'leri, duvar timing oyunları, Silent Drop bait'leri — bunlar round kazandırır. Timeout'u ve mid-round shotcalling'i bu seviyede aktif kullan.
...
- Eco round'da döner kapıyı kullan. Sheriff ya da Spectre ile kapıdan rotate yap. Defender bunu okuyamazsa kill gelir.
- Kırılabilir duvarı kırarken ability harcanır. Raze bot'unu kullanırsa bir bot gider, Breach molly'sini kullanırsa bir ability yuvası gider. Tam buy planlarken bunu hesaba kat.
...
- Rakip B'de Killjoy/Cypher setup'ı oynuyorsa: execute öncesi Raze botu ya da Fade botuyla util'yi tetikle. Killjoy'un tuzağını ve botunu uyandırmadan push atarsan delay yersin — delay yersen rotate gelir, sayı üstünlüğünü kaybedersin.

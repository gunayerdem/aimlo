...
**Raze lehine:**
- Yakın mesafe sitelerde (Bind Hookah, Split B Main, Sunset A) nade duvarın arkasını temizler — duvar hasarı durdurmaz, görüşü keser.
- Sage ult bekliyorken: ult hazır değilse Sage trade'i göze alamaz.
- Raze nade'i duvarın üstüne atarsa Sage pozisyon değiştirmek zorunda kalır.
- Raze ult'u hazırsa duvarı yıkıp arkasındaki Sage'i de alır.
...
**IF** Raze ult'unu (roket) Sage duvarının arkasına attı
**MEANING** Roket duvarı patlatır, arkasındaki Sage açığa çıkar.
**COUNTER** Duvarı Raze'in roket atacağı doğrultuya denk gelmeyecek açıyla kur. Duvar sadece görüşü değil, roketin geliş yönünü de kesmeli.
**WHY** Raze ult'u sabit yönlü roket atar — duvar o yönü kapatmıyorsa roket hem duvarı hem Sage'i götürür.
...
**IF** Raze post-plant nade lineup atacakken Sage duvarla defuse koridorunu kapattı
**MEANING** Duvar nade'in görüş hattını keser, lineup boşa gider.
...
**Split (Dengeli):** A Main'de Sage duvarı Raze'i durdurur, B Main'de Raze nade'i duvarı aşar. Hangi siteye saldırıyorsan o bölgenin kuralı geçerli.

**Ascent (Sage avantajlı):** A Main'de Sage duvarı klasik — Raze nade'i o açıda duvarı aşamaz. B Main'de Raze yakın mesafede güçlü, A'da duvar Raze'i zorlar.

**Icebox (Dengeli):** Sage duvarı A Site girişini keser. Mid'de Raze yakın mesafede avantajlı — iki bölge farklı oynar.

**Haven (Dengeli):** Sage B'de anchor tutar, Raze A Short'tan girer. Hangi siteye baskı yapıldığına göre üstünlük el değiştirir.

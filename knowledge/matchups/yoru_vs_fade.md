---
id: matchup_yoru_vs_fade
type: matchup
agent_a: yoru
agent_b: fade
patch: "9.x"
tags: [matchup, yoru, fade, duelist, initiator]
---

# MATCHUP: Yoru vs Fade
...
**IF** Bot teleport inişini yakaladı
**MEANING** Teleport sonrası Yoru bir an yerinde donar — bot tam bu anı yakalar, nişan alacak vaktin olmaz.
**COUNTER** Teleport marker'ını bot'un geleceği hattın dışına koy. Marker hep aynı yerdeyse Fade bot'u oraya yollar — her round başka nokta seç.
**WHY** Bot, marker konumunu takip eder. Sabit marker = Fade bot'u önceden oraya gönderir. Değişken nokta = bot boşa gider.

---

**IF** Yoru flash attı, clone ve Yoru ikisi birden çıktı
**MEANING** Fade iki hedef görür, karar penceresi daralır.
**COUNTER** Clone ses çıkarmaz, Yoru adım sesi çıkarır. Fade sesi duyduğu tarafa ateş eder — clone'a değil Yoru'ya. Sessiz oyna.
**WHY** Fade'in tek güvenilir okuması sestir. Clone sessizdir; Yoru da susarsa Fade hangisinin gerçek olduğunu bilemez.

---

**IF** Yoru ultta
**MEANING** Yoru görünmez ve hiçbir şeyden etkilenmez — Fade'in elinde tutar bir şey kalmaz.
**COUNTER** Fade ult sesini duyar duymaz takımı pozisyon kapasın. Ult biter bitmez Yoru bir yere çıkmak zorunda — o çıkış noktasını önceden kes.
**WHY** Yoru ult biter bitmez çıkış yapmaya mecbur. Çıkış noktasını bilen Fade orada bekler.

---

**IF** Fade ult'unu Yoru'nun üstüne attı
**MEANING** Alan içinde görüşün kısılır ve ses çıkarırsın — gerçek yerin belli olur, clone bu sesi çıkarmaz.
**COUNTER** Teleport varsa anında alanın dışına çık. Teleport yoksa clone'u alanda bırak, kendini dışarı çek — clone ses çıkarmaz, sen de sus.
**WHY** Ult alanında sesin var, clone'un yok. Sessiz kalabilirsen Fade seni bulamaz.
...
**IF** Yoru clone'u A Main'e, kendini A Short'a sürdü — Fade recon'u sadece A Main'e baktı
**MEANING** Recon tek yönü açar. A Short tarafı karanlık kalır — Yoru mu clone mu orada, belirsiz.
...
**Bind (Yoru avantajlı):** Teleporter ve Hookah, Yoru'nun clone + teleport ikilisine sonuna kadar açık. Fade yakın mesafede bot'u verimli kullanamaz.

**Ascent (Yoru avantajlı):** Mid ve A Main, Yoru teleport'una bol alan açar. Fade A Site recon'u tek tarafa bakar.

**Haven (Fade avantajlı):** 3 site Fade recon'una birebir — Yoru üç siteyi tek başına karıştıramaz.

**Lotus (Fade avantajlı):** 3 site yine Fade lehine. Yoru'nun lurk alanı daralır, Fade her siteye recon atabilir.

**Icebox (Yoru avantajlı):** Uzun hatlar ve dar geçitler Yoru teleport çeşitliliğine yarar.

**Split (Dengeli):** Yoru A Main clone oyununda, Fade B Main takibinde — ikisi de kendi hattında değer üretir.

**Sunset (Fade avantajlı):** Dar geçitler bot'a birebir — Yoru'nun teleport alanı kısıtlı.

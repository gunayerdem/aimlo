---
id: matchup_killjoy_vs_kayo
type: matchup
agent_a: killjoy
agent_b: kayo
patch: "13.00"
verified: 2026-07-08
tags: [matchup, killjoy, kayo, sentinel, initiator]
---

# MATCHUP: Killjoy vs KAY/O
...
**Dengeli:** Haven ve Ascent'te iş bıçak zamanlamasına ve cihaz-oyuncu mesafesine kalır.
...
**MEANING** Cihaz dolduğunda alanda kalan KAY/O donar — hiçbir şey atamaz.
**COUNTER** (KAY/O için) Ult sesini duyar duymaz alandan çekil ya da cihazı bul, odaklı ateşle kır — cihaz hasarla yok edilir.
**WHY** Alandan çıkmayan ya da cihazı kırmayan KAY/O için son durak donmaktır. İçeride yakalanırsan susturma şansın sıfır.

---

**IF** KAY/O ult'ını açtı, Killjoy site'ında
**MEANING** Alandaysan bütün cihazların kapanır, duvarın arkasına çekilsen bile bilgi ve hasar sıfır.
**COUNTER** Ult sesini duyar duymaz sipere gir, bekle. Ult bitince cihazlarını hemen yeniden kur. Ult açıkken düelloya girme — util olmadan o düelloyu kazanamazsın.
...
**IF** Killjoy molly'si KAY/O'nun bıçak atış noktasında
**MEANING** Atış pozisyonu sabittir — molly tam o anda patlarsa KAY/O hem hasar alır hem planı bozulur.
**COUNTER** (KAY/O için) Molly sesini duyarsan atış pozisyonunu değiştir, aynı noktadan atma.
**WHY** İyi Killjoy oyuncuları molly'yi KAY/O'nun bıçak atabileceği bilinen noktalara göre önceden kurar — bıçak gelir gelmez patlatır, atış anında hasarı basar.

---

**IF** KAY/O molly + bıçak aynı noktaya geldi, Killjoy anchor pozisyonunda
**MEANING** Hem can kaybı hem cihaz kaybı — iki ceza aynı anda.
**COUNTER** Anchor pozisyonunu molly hattının ve bıçak hattının dışına al. İki lineup aynı noktayı tutuyorsa orası artık güvenli değil — yer değiştir.
...
Ult farkı: KAY/O ult'ı Killjoy için en büyük tehdit. KAY/O ult'ını açtıysa kendi ult'ını sakla — onunki bitince at.
...
Bu matchup'ta Killjoy'un tek gerçek derdi bıçak. Kendini bıçağın tipik hedef noktalarının dışında tut — cihazların sana bağlı, sen yakalanmazsan onlar çalışır. Bıçak sesini duyar duymaz köşe al ve bıçağı vur. Bunu yaparsan KAY/O elinde sadece flash + molly kalan bir ajan olur — o zaman matchup senin.

KAY/O oynuyorsan: bıçağı cihaza değil Killjoy'un kendisine at. Molly'yi bilinen tutuş noktalarına önceden kur. Ult'ını Killjoy site'ı aktif savunurken aç — cihazlar kapanınca takımın içeri girer.

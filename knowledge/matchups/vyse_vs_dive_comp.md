...
**COUNTER**: Aynı anda iki farklı açıdan gir — Vyse tek noktayı bozabilir, ikisini birden kapatamaz
**WHY**: Silah bozma iniş anında vurur, bunu geçmenin tek yolu noktayı dağıtmak

**IF**: Duvar, dalıcı girdikten hemen sonra kapanıyor ve takip eden oyuncuları site dışında bırakıyor
**MEANING**: Dalıcı içeride yalnız, 1v2 ya da 1v3 dövüşüyor
...
**COUNTER**: Tuzakları genel koridora değil, dalıcıların bastığı somut iniş noktasına koy
**WHY**: Hız, tuzağın aktive olma süresini geçiyor — noktayı kestirirsen hız işe yaramaz

**IF**: Dive, girmeden önce molly veya recon ile tuzakları patlattıktan sonra giriyor
**MEANING**: Tek katman tuzağın var — ilki gidince içerisi açık
**COUNTER**: Tuzakları katmanla: ilk tuzak patlarsa arkasında ikinci tuzak olsun, ya da silah bozma alanıyla birleştir
**WHY**: Tek tuzağı temizlemek kolay — ikinci katman dalıcıyı sürprizle yakalar

## Sürekli Kaybediyorsan Ne Anlama Gelir

**Vyse sürekli dive tarafından eziliyorsa**: Tuzakların ya yanlış noktada ya da tek katmanlı. Jett'in nereye bastığını, Raze'in nereye indiğini, Neon'un nereye kaydığını izle — tuzak o noktaya gider, koridorun ortasına değil.

**Dive sürekli tuzağa takılıyorsa**: İçeri girmeden önce tek bir yetenek bile harcamıyorsun. Recon at, molly at, bot gönder — tuzağı temizlemeden atladığın her sefer aynı sonuç çıkar.
...
### Oyuncu Dive oynuyorsa
**Tuzaklara takılıyorsa**: "Dalmadan önce tuzağı temizle. Bir recon, bir molly, bir bot yeter — onu patlatmadan atlama."

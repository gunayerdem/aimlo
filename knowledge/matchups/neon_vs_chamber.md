...
Neon sprint ve slide'la açıları geçer — durmaz, tutmaz. Chamber Op'u tek atışa dayanır, o atış ıskalayınca Neon zaten üstüne gelmiştir. Tabancası sprint eden hedefe Op'tan daha uygun ama yakın mesafede yeterli değil. TP, Chamber'ın kaçış yoludur — ama Neon sprint'i TP noktasına çoğu ajandan hızlı ulaşır.

## Baskı Kalıpları

### Neon Chamber'ı Yeniyorsa

**IF**: Neon sprint hızıyla görüş hattını Chamber tepki veremeden geçiyor
...
**IF**: Neon stun ile Chamber'ın durduğu noktayı vuruyor
**MEANING**: Chamber ya erken TP yapar ya stun yer — her ikisi de pozisyon kaybı
**COUNTER**: Chamber tuzağı Neon'un sprint yoluna koy — erken uyarı ve yavaşlatma
**WHY**: Stun geldiğinde Chamber zaten yerinde değil, ama tuzak önceden haber verir

### Chamber Neon'u Yeniyorsa
...
**COUNTER**: Neon duvarla görüş hattını tamamen kapat, açıyı geç
...
Chamber, Neon'a karşı tabanca ağırlıklı oynar — TP'yi kaçmak için değil, ikinci açıyı kesmek için kullanır. Neon'un entry'sinde stun ve flash aynı anda patlar; Chamber o anı okuyup TP'ye erken basmak yerine tam o anda karşı açıdan çıkarsa düelloyu çevirir.

Neon her round giriş açısını değiştirmeli: stun nereye gitti, duvar nereye açıldı — Chamber bir önceki roundun kalıbından tahmin yürütür.

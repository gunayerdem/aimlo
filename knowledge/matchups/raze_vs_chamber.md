...
- Dar koridorlu sitelerde (Bind Hookah, Sunset A, Split B Main): nade Chamber'ın durduğu noktayı yakar, teleport dar koridorda işine yaramaz
- Chamber ultsuz oynuyorsa: ult yokken Chamber sıradan bir op tutucudur — nade ile noktasını kır
- Nade tuzak hattına düştüğünde: tuzak patlar, Chamber o round körleşir, ikinci entry açılır
- Ult'un hazır, Chamber teleport menzilinin dışındaysa: tek atışla bitir, kaçıştan başka şansı yok
...
**COUNTER** Tuzağı nade lineup hattından uzağa kur. Nade hangi açıdan gelir, oku, tuzağı oradan uzaklaştır.
**WHY** Chamber'ın tek tuzağı var, Raze'in tek nade'i. Raze nade'i uzun hattan atarsa Chamber bilgi kaynağını kaybeder — bire bir takas.
...
**IF** Raze ult'unu Chamber'ın durduğu noktaya fırlattı, Chamber'ın teleportu hazır
**MEANING** Roket tek atışta öldürür — ama Chamber ult sesini duyar duymaz teleport çekerse roket hedefe ulaşamaz
**COUNTER** Ult sesini duyduğun an teleportu çek. Ses tetiktir, bekleme.
**WHY** Roket sabit yolda gider, teleport anlıktır. Chamber zamanında çekerse roket boşa gider — geç çekerse ölür.

---

**IF** Chamber op ultunu post-plant'te Raze'in üstüne çevirdi, Raze düz site ortasındaydı
**MEANING** Tek atışlık op ult kesindir — Raze açık duruyor, shot yer
**COUNTER** Post-plant'te off-angle'da dur, site ortasında açık kalma. Ult sesi duyulunca takıma rotate sinyali ver.
**WHY** Op ult uzun açıda dengesiz güçtür — Raze ult hattının dışına çıkarsa Chamber shot bulamaz.
...
**IF** Chamber tabancasıyla Raze'e yakın mesafede girdi, Raze'in nade'i hazır
**MEANING** Tabanca tek atışlık ama Raze nade yakın mesafede ölümcül — Chamber nade'e girerse biter
**COUNTER** Yakın mesafede tabanca çekme — teleportla uzağa çekil. Raze nade'i patladığında hâlâ aynı hattaysan ölürsün.
**WHY** Chamber'ın gücü mesafededir. Yakına girdiğinde Raze nade tek atışta seni bitirir.

---

**IF** Raze nade'i Chamber'ın teleport hattına lineup'ladı, nokta patladı
**MEANING** Chamber artık teleportsuz — sıradan bir op tutucu, avantaj tamamen gitti
...
**Haven (Dengeli):** Chamber C Long'da op ile güçlü. Raze A Short'ta güçlü. Hangi site oynanıyor, ona bak.

**Ascent (Chamber avantajlı):** Mid ve A Main uzun açılı. Chamber op hattı bulur. Raze A Main entry'de yakına sıkışır.

**Lotus (Dengeli):** A Site girişi dar — Raze nade değer kazanır. B Site uzun koridorlu — Chamber op hattı açılır. C Site dar köşeler Raze'in. Hangi siteye yığılıyorlar, avantaj ona göre kayar.

**Icebox (Chamber avantajlı):** Mid Tube ve Rafters uzun açı, Chamber için biçilmiş kaftan. Raze Icebox'ta yakın mesafe az bulur.
...
**Patch 9.x notu:** Bu patch'te teleport menzili düştü — noktanı daha erken kurman gerek, son saniyeye bırakma. Op ult bu patch'te 3 atış hakkıyla geliyor; Chamber 3. atışı kullanana kadar ult aktif, 3. atıştan sonra biter.

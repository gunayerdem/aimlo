...
Double initiator (Sova + KAY/O, Breach + Skye, Fade + Gekko) bilgi üretir — flash, dart, recon ile site'ı görmeden girer. Double sentinel (Killjoy + Cypher, Chamber + Killjoy, Deadlock + Cypher) bilgi kapatır — tuzak, alarmbot, tripwire ile seni görmeden durdurur.

Bu matchup şuna gelir: bilgi toplarsan ve o bilgiyi girişe çevirirsen kazanırsın. Karşı taraf o bilgiyi engellerse ve tuzağıni tetikletirse kazanır. İkisi de yarım iş yaparsa maç uzar.

## 2. Hangi Taraf Avantajlı

**Double initiator lehine:**
- Harita açık ve geniş angle'lıysa (Breeze, Icebox) — flash + dart zinciri site'ı tarar, tuzak hattı kaplayamaz
...
- Sentinel ikilisi iki farklı angle'da setup kurduysa — tuzak + alarmbot + molly üst üste, giriş çok pahalı
- Savunma full-buy, setup her round farklı yerdeyse — initiator bir önceki bilgiyi kullanamaz
- Kadroda duelist yoksa — entry sadece utility'ye düştü, tuzak hattı her girişi tag'ler
...
**COUNTER** Flash sesini duyduğunda duvara dön. Dart tag'ini rotate sinyali olarak oku, görmezden gelme. Flash geçtikten sonra tuzağıni yeni pozisyona çek
...
**COUNTER** Savunmada close angle hold kur, saldırı zayıflıklarını sömür — utility'siz gelen sentinel'ları tuzağ'le
...
**MEANING** Tuzak hattı söküldü, o round sentinel savunma ekonomisi sıfırlandı
...
**WHY** Görünür tuzak ölümcül. Görünmez tuzak initiator'ın söküp sökmediğini bilemez — bilemediği tuzağı tetikler, tetiklenen tuzak sana bilgi verir.
...
Sonuç: Round sayısı 15'in altındaysa sentinel setup baskısı yüksek — her giriş tuzak hattına çarpar. Round sayısı 20'yi geçtiyse initiator ult stoku dolmuştur — o rounddan itibaren giriş baskısı artar, sentinel ult yoksa site'ı boşalt.

## 5. Map Bazlı Değişim

**Bind (double sentinel avantajlı):** TP rotate + Hookah + Showers dar geçitleri tuzak hattının evi. Flash sentinel tuzağıni bulamaz, TP rotate zinciri kapanır.

**Breeze (double initiator avantajlı):** Geniş site alanları tuzak hattını dağıtır, kaplayamaz. Recon zinciri site'ı tarar, giriş temiz.

**Icebox (double initiator avantajlı):** Dikey oyun + uzun sightline dart ve flash için ideal. Sentinel tuzak hattı dikey ekonomide yetersiz kalır.
...
**Split (double sentinel avantajlı):** Dar koridor + dikey oyun tuzak hattının evi. Savunma tarafında double sentinel Split'te 10+ round alır.

**Sunset (double initiator avantajlı):** A Main açık angle + Mid initiator utility hattı. Sentinel tuzak hattı tek site'a sıkışır.
...
**Flip 2 — Tuzak görünürlüğü:** Tuzak hattı ilk roundda açığa çıktıysa initiator ikinci roundda o hattı siler, double sentinel çökmüştür. Gizli kalıyorsa sentinel matchup'ı kilitler.

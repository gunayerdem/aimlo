---
id: matchup_jett_vs_fade
type: matchup
agent_a: jett
agent_b: fade
patch: "9.x"
tags: [matchup, jett, fade, duelist, initiator]
---

# MATCHUP: Jett vs Fade

## 1. Matchup Özü

Fade seni bulmaya çalışır, sen de bulunmamaya. Recon, bot ve stun zinciriyle dash hattını kapatır. O zinciri kırarsan Fade'in util'i boşa gider, sen serbest kalırsın. Zinciri tam kurarsa — dash cooldown'dayken stun ve bot üst üste gelir — ölürsün. Bu matchup baştan sona bir info savaşı.
...
- Dash cooldown'dayken recon seni gösterir, stun yere çiviler, bot kovalar — kaçamazsın.
- Recon seni işaretlediyse Fade takımı saldırı hattını bilir, trade ortağı hazır bekler.
...
**IF** Stun rotate hattını kesti
**MEANING** Stun içinde yavaşlar, görüşün bozulur. Dash hâlâ çalışır ama momentumunu kaybedersin.
**COUNTER** Stun lineup'larını ilk round'da ezberle. Rotate'i stun menzilinin dışından yap. Stun tek kullanımlık — harcatırsan o round serbest geçersin.
**WHY** Stun dash'in değerini düşürür. Menzil dışı hat tek temiz çıkışın.
...
**IF** Fade zinciri tam kurdu: recon → stun → bot
**MEANING** Önce gösterir, sonra çiviler, sonra kovalar. Dash'i harcadıysan veya cooldown'daysan ölürsün.
**COUNTER** Zincirin ilk halkasını (recon) gördüğün an dash'i hemen aç. Stun hattına girmeden menzilin dışına çık.
**WHY** Fade zincir oyuncusu. İlk halkayı okursan zincir çöker. Okuyamazsan her halka sana bir şey kaybettirir.
...
**Lotus (Fade avantajlı):** 3 site yapısı Fade'in işine yarar. Jett Lotus'ta zayıf bir pick.
...
Her round'un başında Fade'in util'ini takip et — recon nereye oturdu, bot hangi yönden geldi, stun nereye düştü. Bu üçünü bilirsen zinciri kurmadan bozarsın. Bilmezsen Fade her round seni bir adım önce bulur.

Dash'i recon'dan kaçmak için harcama. Stun ve bot geldiğinde dash'in hazır olsun — asıl kaçış tam orada.
